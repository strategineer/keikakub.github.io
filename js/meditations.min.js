...
So make your exit with grace—the same grace shown to you.`);let meditationKeys=[...meditations.keys()];function getAllMeditationKeys(e){let n=[],t;for(t=0;t<ExplorerImp.map.size;t++){const s=ExplorerImp.keys[t];if(s==ExplorerImp.currentKey)continue;ExplorerImp.map.get(s).toLowerCase().includes(e)&&n.push(s)}return n}ExplorerImp={map:meditations,keys:meditationKeys,count:1,onDefaultActionActivated:function(){setRandomDiscovery()},onSetDiscovery:function(e){const n=e[0];let t=document.getElementById("explorer-text");typeof t!="undefined"&&t!==null&&(t.innerText=n.discovery)},generateShareData:function(e){const t=e[0];return{title:`Marcus Aurelius's Meditation ${t.key}`,text:t.discovery,url:window.location.href}},onClickWord:function(e){const t=pickOne(getAllMeditationKeys(e));setDiscovery(t)}}