let meditations=new Map;meditations.set("1.1",`1.1
MY GRANDFATHER VERUS​
Character and self-control.`),meditations.set("1.2",`1.2
MY FATHER (FROM MY OWN MEMORIES AND HIS REPUTATION)​
Integrity and manliness.`),meditations.set("1.3",`1.3
MY MOTHER​
Her reverence for the divine, her generosity, her inability not only to do wrong but even to conceive of doing it. And the simple way she lived—not in the least like the rich.`),meditations.set("1.4",`1.4
MY GREAT-GRANDFATHER​
To avoid the public schools, to hire good private teachers, and to accept the resulting costs as money well-spent.`),meditations.set("1.5",`1.5
MY FIRST TEACHER​
Not to support this side or that in chariot-racing, this fighter or that in the games. To put up with discomfort and not make demands. To do my own work, mind my own business, and have no time for slanderers.`),meditations.set("1.6",`1.6
DIOGNETUS​
Not to waste time on nonsense. Not to be taken in by conjurors and hoodoo artists with their talk about incantations and exorcism and all the rest of it. Not to be obsessed with quail-fighting or other crazes like that. To hear unwelcome truths. To practice philosophy, and to study with Baccheius, and then with Tandasis and Marcianus. To write dialogues as a student. To choose the Greek lifestyle—the camp-bed and the cloak.`),meditations.set("1.7",`1.7
RUSTICUS​
...
And for introducing me to Epictetus’s lectures—and loaning me his own copy.`),meditations.set("1.8",`1.8
APOLLONIUS​
...
And to have learned how to accept favors from friends without losing your self-respect or appearing ungrateful.`),meditations.set("1.9",`1.9
SEXTUS​
Kindness.
...
To praise without bombast; to display expertise without pretension.`),meditations.set("1.10",`1.10
THE LITERARY CRITIC ALEXANDER​
Not to be constantly correcting people, and in particular not to jump on them whenever they make an error of usage or a grammatical mistake or mispronounce something, but just answer their question or add another example, or debate the issue itself (not their phrasing), or make some other contribution to the discussion—and insert the right expression, unobtrusively.`),meditations.set("1.11",`1.11
FRONTO​
To recognize the malice, cunning, and hypocrisy that power produces, and the peculiar ruthlessness often shown by people from “good families.”`),meditations.set("1.12",`1.12
ALEXANDER THE PLATONIST​
Not to be constantly telling people (or writing them) that I’m too busy, unless I really am. Similarly, not to be always ducking my responsibilities to the people around me because of “pressing business.”`),meditations.set("1.13",`1.13
CATULUS​
Not to shrug off a friend’s resentment—even unjustified resentment—but try to put things right.
To show your teachers ungrudging respect (the Domitius and Athenodotus story), and your children unfeigned love.`),meditations.set("1.14",`1.14
[MY BROTHER] SEVERUS​
...
And that when people incurred his disapproval, they always knew it. And that his friends never had to speculate about his attitude to anything: it was always clear.`),meditations.set("1.15",`1.15
MAXIMUS​
...
A sense of humor.`),meditations.set("1.16",`1.16
MY ADOPTED FATHER​
...
(Maximus’s illness.)`),meditations.set("1.17",`1.17
THE GODS​
...
All things for which “we need the help of fortune and the gods.”`),meditations.set("2.1",`2.1
When you wake up in the morning, tell yourself: The people I deal with today will be meddling, ungrateful, arrogant, dishonest, jealous, and surly. They are like this because they can’t tell good from evil. But I have seen the beauty of good, and the ugliness of evil, and have recognized that the wrongdoer has a nature related to my own—not of the same blood or birth, but the same mind, and possessing a share of the divine. And so none of them can hurt me. No one can implicate me in ugliness. Nor can I feel angry at my relative, or hate him. We were born to work together like feet, hands, and eyes, like the two rows of teeth, upper and lower. To obstruct each other is unnatural. To feel anger at someone, to turn your back on him: these are obstructions.`),meditations.set("2.2",`2.2
...
Think of it this way: You are an old man. Stop allowing your mind to be a slave, to be jerked about by selfish impulses, to kick against fate and the present, and to mistrust the future.`),meditations.set("2.3",`2.3
...
And then there is necessity and the needs of the whole world, of which you are a part. Whatever the nature of the whole does, and whatever serves to maintain it, is good for every part of nature. The world is maintained by change—in the elements and in the things they compose. That should be enough for you; treat it as an axiom. Discard your thirst for books, so that you won’t die in bitterness, but in cheerfulness and truth, grateful to the gods from the bottom of your heart.`),meditations.set("2.4",`2.4
Remember how long you’ve been putting this off, how many extensions the gods gave you, and you didn’t use them.
At some point you have to recognize what world it is that you belong to; what power rules it and from what source you spring; that there is a limit to the time assigned you, and if you don’t use it to free yourself it will be gone and will never return.`),meditations.set("2.5",`2.5
Concentrate every minute like a Roman—like a man—on doing what’s in front of you with precise and genuine seriousness, tenderly, willingly, with justice. And on freeing yourself from all other distractions. Yes, you can—if you do everything as if it were the last thing you were doing in your life, and stop being aimless, stop letting your emotions override what your mind tells you, stop being hypocritical, self-centered, irritable. You see how few things you have to do to live a satisfying and reverent life? If you can manage this, that’s all even the gods can ask of you.`),meditations.set("2.6",`2.6
Yes, keep on degrading yourself, soul. But soon your chance at dignity will be gone. Everyone gets one life. Yours is almost used up, and instead of treating yourself with respect, you have entrusted your own happiness to the souls of others.`),meditations.set("2.7",`2.7
Do external things distract you? Then make time for yourself to learn something worthwhile; stop letting yourself be pulled in all directions. But make sure you guard against the other kind of confusion. People who labor all their lives but have no purpose to direct every thought and impulse toward are wasting their time—even when hard at work.`),meditations.set("2.8",`2.8
Ignoring what goes on in other people’s souls—no one ever came to grief that way. But if you won’t keep track of what your own soul’s doing, how can you not be unhappy?`),meditations.set("2.9",`2.9
...
ii. that the longest-lived and those who will die soonest lose the same thing. The present is all that they can give up, since that is all you have, and what you do not have, you cannot lose.`),meditations.set("2.15",`2.15
“Everything is just an impression.” —Monimus the Cynic. And the response is obvious enough. But the point is a useful one, if you take it for what it’s worth.`),meditations.set("2.16",`2.16
...
v. When it allows its action and impulse to be without a purpose, to be random and disconnected: even the smallest things ought to be directed toward a goal. But the goal of rational beings is to follow the rule and law of the most ancient of communities and states.`),meditations.set("2.17",`2.17
Human life.
...
And nothing natural is evil.`),meditations.set("3.1",`3.1
...
So we need to hurry.
Not just because we move daily closer to death but also because our understanding—our grasp of the world—may be gone before we get there.`),meditations.set("3.2",`3.2
...
One is mind and spirit, the other earth and garbage.`),meditations.set("3.4",`3.4
...
And the others? He bears in mind what sort of people they are—both at home and abroad, by night as well as day—and who they spend their time with. And he cares nothing for their praise—men who can’t even meet their own standards.`),meditations.set("3.5",`3.5
How to act:
...
To stand up straight—not straightened.`),meditations.set("3.6",`3.6
...
As a rational being? Then follow through. Or just as an animal? Then say so and stand your ground without making a show of it. (Just make sure you’ve done your homework first.)`),meditations.set("3.7",`3.7
Never regard something as doing you good if it makes you betray a trust, or lose your sense of shame, or makes you show hatred, suspicion, ill will, or hypocrisy, or a desire for things best done behind closed doors. If you can privilege your own mind, your guiding spirit and your reverence for its powers, that should keep you clear of dramatics, of wailing and gnashing of teeth. You won’t need solitude—or a cast of thousands, either. Above all, you’ll be free of fear and desire. And how long your body will contain the soul that inhabits it will cause you not a moment’s worry. If it’s time for you to go, leave willingly—as you would to accomplish anything that can be done with grace and honor. And concentrate on this, your whole life long: for your mind to be in the right state—the state a rational, civic mind should be in.`),meditations.set("3.8",`3.8
...
Neither servility nor arrogance. Neither cringing nor disdain. Neither excuses nor evasions.`),meditations.set("3.9",`3.9
Your ability to control your thoughts—treat it with respect.
It’s all that protects your mind from false perceptions—false to your nature, and that of all rational beings. It’s what makes thoughtfulness possible, and affection for other people, and submission to the divine.`),meditations.set("3.10",`3.10
Forget everything else. Keep hold of this alone and remember it: Each of us lives only now, this brief instant.
The rest has been lived already, or is impossible to see. The span we live is small—small as the corner of the earth in which we live it. Small as even the greatest renown, passed from mouth to mouth by short-lived stick figures, ignorant alike of themselves and those long dead.`),meditations.set("3.11",`3.11
...
And in inconsequential things? I’ll do my best to treat them as they deserve.”`),meditations.set("3.12",`3.12
...
No one can prevent that.`),meditations.set("3.13",`3.13
Doctors keep their scalpels and other instruments handy, for emergencies. Keep your philosophy ready too—ready to understand heaven and earth. In everything you do, even the smallest thing, remember the chain that links them. Nothing earthly succeeds by ignoring heaven, nothing heavenly by ignoring the earth.`),meditations.set("3.14",`3.14
Stop drifting. You’re not going to re-read your Brief Comments, your Deeds of the Ancient Greeks and Romans, the commonplace books you saved for your old age. Sprint for the finish. Write off your hopes, and if your well-being matters to you, be your own savior while you can.`),meditations.set("3.15",`3.15
They don’t realize how much is included in stealing, sowing, buying, resting, seeing to business (not with the eyes, but another kind of sight).`),meditations.set("3.16",`3.16
Body. Soul. Mind.
Sensations: the body.
Desires: the soul.
Reasoning: the mind.
...
What’s thrown on top of the conflagration is absorbed, consumed by it—and makes it burn still higher.`),meditations.set("4.2",`4.2
No random actions, none not based on underlying principles.`),meditations.set("4.3",`4.3
...
“The world is nothing but change. Our life is only perception.”`),meditations.set("4.4",`4.4
...
So thought must derive from somewhere else as well.`),meditations.set("4.5",`4.5
Death: something like birth, a natural mystery, elements that split and recombine.

Not an embarrassing thing. Not an offense to reason, or our nature.`),meditations.set("4.6",`4.6
That sort of person is bound to do that. You might as well resent a fig tree for secreting juice. (Anyway, before very long you’ll both be dead—dead and soon forgotten.)`),meditations.set("4.7",`4.7
Choose not to be harmed—and you won’t feel harmed.
Don’t feel harmed—and you haven’t been.`),meditations.set("4.8",`4.8
It can ruin your life only if it ruins your character.
Otherwise it cannot harm you—inside or out.`),meditations.set("4.9",`4.9
It was for the best. So Nature had no choice but to do it.`),meditations.set("4.10",`4.10
...
Keep to it in everything you do.`),meditations.set("4.11",`4.11
Not what your enemy sees and hopes that you will, but what’s really there.`),meditations.set("4.12",`4.12
Two kinds of readiness are constantly needed: (i) to do only what the logos of authority and law directs, with the good of human beings in mind; (ii) to reconsider your position, when someone can set you straight or convert you to his. But your conversion should always rest on a conviction that it’s right, or benefits others—nothing else. Not because it’s more appealing or more popular.`),meditations.set("4.13",`4.13
You have a mind?
—Yes.
Well, why not use it? Isn’t that all you want—for it to do its job?`),meditations.set("4.14",`4.14
...
By being changed.`),meditations.set("4.15",`4.15
Many lumps of incense on the same altar. One crumbles now, one later, but it makes no difference.`),meditations.set("4.16",`4.16
Now they see you as a beast, a monkey. But in a week they’ll think you’re a god—if you rediscover your beliefs and honor the logos.`),meditations.set("4.17",`4.17
Not to live as if you had endless years ahead of you.
Death overshadows you. While you’re alive and able—be good.`),meditations.set("4.18",`4.18
...
< . . . > not to be distracted by their darkness. To run straight for the finish line, unswerving.`),meditations.set("4.19",`4.19
...
“ You’re out of step—neglecting the gifts of nature to hand on someone’s words in the future. “`),meditations.set("4.20",`4.20
...
Bushes?`),meditations.set("4.21",`4.21
...
Through analysis: material and cause.`),meditations.set("4.22",`4.22
Not to be driven this way and that, but always to behave with justice and see things as they are.`),meditations.set("4.23",`4.23
...
The poet says “dear city of Cecrops . . .” Can’t you bring yourself to say “of Zeus”?`),meditations.set("4.24",`4.24
...
But we need to eliminate unnecessary assumptions as well. To eliminate the unnecessary actions that follow.`),meditations.set("4.25",`4.25
And then you might see what the life of the good man is like—someone content with what nature assigns him, and satisfied with being just and kind himself.`),meditations.set("4.26",`4.26
...
Unrestrained moderation.`),meditations.set("4.27",`4.27
An ordered world or a mishmash. But still an order. Can there be order within you and not in everything else? In things so different, so dispersed, so intertwined?`),meditations.set("4.28",`4.28
Character: dark, womanish, obstinate. Wolf, sheep, child, fool, cheat, buffoon, salesman, tyrant.`),meditations.set("4.29",`4.29
...
Rebel: (n.) one who is rebellious, one who withdraws from the logos of Nature because he resents its workings. (It produced you; now it produces this.) Schismatic: (n.) one who separates his own soul from others with the logos. They should be one.`),meditations.set("4.30",`4.30
A philosopher without clothes and one without books. “I have nothing to eat,” says he, as he stands there half-naked,
“but I subsist on the logos.” And with nothing to read, I subsist on it too.`),meditations.set("4.31",`4.31
Love the discipline you know, and let it support you.
Entrust everything willingly to the gods, and then make your way through life—no one’s master and no one’s slave.`),meditations.set("4.32",`4.32
...
A key point to bear in mind: The value of attentiveness varies in proportion to its object. You’re better off not giving the small things more time than they deserve.`),meditations.set("4.33",`4.33
...
Only this: proper understanding; unselfish action; truthful speech. A resolve to accept whatever happens as necessary and familiar, flowing like water from that same source and spring.`),meditations.set("4.34",`4.34
Hand yourself over to Clotho voluntarily, and let her spin you into whatever she pleases.`),meditations.set("4.35",`4.35
Everything transitory—the knower and the known.`),meditations.set("4.36",`4.36
Constant awareness that everything is born from change.
The knowledge that there is nothing nature loves more than to alter what exists and make new things like it. All that exists is the seed of what will emerge from it. You think the only seeds are the ones that make plants or children? Go deeper.`),meditations.set("4.37",`4.37
On the verge of dying and still weighed down, still turbulent, still convinced external things can harm you, still rude to other people, still not acknowledging the truth: that wisdom is justice.`),meditations.set("4.38",`4.38
Look into their minds, at what the wise do and what they don’t.`),meditations.set("4.39",`4.39
...
In your capacity to see it. Stop doing that and everything will be fine. Let the part of you that makes that judgment keep quiet even if the body it’s attached to is stabbed or burnt, or stinking with pus, or consumed by cancer. Or to put it another way: It needs to realize that what happens to everyone—bad and good alike—is neither good nor bad. That what happens in every life—lived naturally or not—is neither natural nor unnatural.`),meditations.set("4.40",`4.40
The world as a living being—one nature, one soul. Keep that in mind. And how everything feeds into that single experience, moves with a single motion. And how everything helps produce everything else. Spun and woven together.`),meditations.set("4.41",`4.41
“A little wisp of soul carrying a corpse.”—Epictetus.`),meditations.set("4.42",`4.42
There is nothing bad in undergoing change—or good in emerging from it.`),meditations.set("4.43",`4.43
Time is a river, a violent current of events, glimpsed once and already carried past us, and another follows and is gone.`),meditations.set("4.44",`4.44
Everything that happens is as simple and familiar as the rose in spring, the fruit in summer: disease, death, blasphemy, conspiracy . . . everything that makes stupid people happy or angry.`),meditations.set("4.45",`4.45
...
Not a mere sequence, but an astonishing concordance.`),meditations.set("4.46",`4.46
...
“Our words and actions should not be like those of sleepers” (for we act and speak in dreams as well) “or of children copying their parents”—doing and saying only what we have been told.`),meditations.set("4.47",`4.47
...
—what difference could it make? Now recognize that the difference between years from now and tomorrow is just as small.`),meditations.set("4.48",`4.48
...
Praising its mother, thanking the tree it grew on.`),meditations.set("4.49",`4.49
...
So remember this principle when something threatens to cause you pain: the thing itself was no misfortune at all; to endure it and prevail is great good fortune.`),meditations.set("4.50",`4.50
...
Our lifetime is so brief. And to live it out in these circumstances, among these people, in this body? Nothing to get excited about. Consider the abyss of time past, the infinite future. Three days of life or three generations: what’s the difference?`),meditations.set("4.51",`4.51
Take the shortest route, the one that nature planned—to speak and act in the healthiest way. Do that, and be free of pain and stress, free of all calculation and pretension.`),meditations.set("5.1",`5.1
...
Is helping others less valuable to you? Not worth your effort?`),meditations.set("5.2",`5.2
To shrug it all off and wipe it clean—every annoyance and distraction—and reach utter stillness.
Child’s play.`),meditations.set("5.3",`5.3
...
And you need to work on that as well—that slowness. Not something to be ignored, let alone to prize.`),meditations.set("5.6",`5.6
...
That’s true. But you’re misunderstanding me. You’ll wind up like the people I mentioned before, misled by plausible reasoning. But if you make an effort to understand what I’m saying, then you won’t need to worry about neglecting your social duty.`),meditations.set("5.7",`5.7
Prayer of the Athenians:

Zeus, rain down, rain down On the land and fields of Athens.

Either no prayers at all—or one as straightforward as that.`),meditations.set("5.8",`5.8
...
—from its continuity and its coherence. Not only its parts, but its purposes. And that’s what you’re doing when you complain: hacking and destroying.`),meditations.set("5.9",`5.9
...
Prudence? Piety? And is there anything preferable to thought itself—to logic, to understanding? Think of their surefootedness. Their fluent stillness.`),meditations.set("5.10",`5.10
...
ii. I can keep from doing anything that God and my own spirit don’t approve. No one can force me to.`),meditations.set("5.11",`5.11
What am I doing with my soul?
Interrogate yourself, to find out what inhabits your socalled mind and what kind of soul you have now. A child’s soul, an adolescent’s, a woman’s? A tyrant’s soul? The soul of a predator—or its prey?`),meditations.set("5.12",`5.12
...
Now go a step further. Ask yourself whether we should accept as goods—and should value—the things we have to think of to have the line make sense—the ones whose abundance leaves their owner with “. . . no place to shit.”`),meditations.set("5.13",`5.13
...
N.B.: Still holds good, even if the world goes through recurrent cycles.`),meditations.set("5.14",`5.14
The logos and its employment are forces sufficient for themselves and for their works. They start from their own beginning, they proceed to the appointed end. We call such activities “directed,” from the directness of their course.`),meditations.set("5.15",`5.15
...
(and things like them)—or are deprived of them involuntarily, even—the better we become.`),meditations.set("5.16",`5.16
...
A rational being’s good is unselfishness. What we were born for. That’s nothing new. Remember? Lower things for the sake of higher ones, and higher ones for one another. Things that have consciousness are higher than those that don’t. And those with the logos still higher.`),meditations.set("5.17",`5.17
It is crazy to want what is impossible. And impossible for the wicked not to do so.`),meditations.set("5.18",`5.18
...
“character.” Is wisdom really so much weaker than ignorance and vanity?`),meditations.set("5.19",`5.19
Things have no hold on the soul. They have no access to it, cannot move or direct it. It is moved and directed by itself alone. It takes the things before it and interprets them as it sees fit.`),meditations.set("5.20",`5.20
...
What stands in the way becomes the way.`),meditations.set("5.21",`5.21
Honor that which is greatest in the world—that on whose business all things are employed and by whom they are governed.
And honor what is greatest in yourself: the part that shares its nature with that power. All things—in you as well—are employed about its business, and your life is governed by it.`),meditations.set("5.22",`5.22
If it does not harm the community, it does not harm its members.
When you think you’ve been injured, apply this rule: If the community isn’t injured by it, neither am I. And if it is, anger is not the answer. Show the offender where he went wrong.`),meditations.set("5.23",`5.23
...
So it would take an idiot to feel self-importance or distress. Or any indignation, either. As if the things that irritate us lasted.`),meditations.set("5.24",`5.24
Remember:
Matter. How tiny your share of it.
Time. How brief and fleeting your allotment of it.
Fate. How small a role you play in it.`),meditations.set("5.25",`5.25
So other people hurt me? That’s their problem. Their character and actions are not mine. What is done to me is ordained by nature, what I do by my own.`),meditations.set("5.26",`5.26
The mind is the ruler of the soul. It should remain unstirred by agitations of the flesh—gentle and violent ones alike. Not mingling with them, but fencing itself off and keeping those feelings in their place. When they make their way into your thoughts, through the sympathetic link between mind and body, don’t try to resist the sensation. The sensation is natural. But don’t let the mind start in with judgments, calling it “good” or “bad.”`),meditations.set("5.27",`5.27
“To live with the gods.” And to do that is to show them that your soul accepts what it is given and does what the spirit requires—the spirit God gave each of us to lead and guide us, a fragment of himself. Which is our mind, our logos.`),meditations.set("5.28",`5.28
...
28a. Neither player-king nor prostitute.`),meditations.set("5.29",`5.29
...
Until things reach that point, I’m free. No one can keep me from doing what I want. And I want what is proper to rational beings, living together.`),meditations.set("5.30",`5.30
The world’s intelligence is not selfish.
It created lower things for the sake of higher ones, and attuned the higher ones to one another. Look how it subordinates, how it connects, how it assigns each thing what each deserves, and brings the better things into alignment.`),meditations.set("5.31",`5.31
...
How much pain and pleasure have you resisted? How many honors have you declined? How many unkind people have you been kind to?`),meditations.set("5.32",`5.32
Why do other souls—unskilled, untrained—disturb the soul with skill and understanding?
—And which is that?
The one that knows the beginning and the end, and knows the logos that runs through all things and that assigns to all a place, each in its allotted span, throughout the whole of time.`),meditations.set("5.33",`5.33
...
—and nothing else is under your control.`),meditations.set("5.34",`5.34
...
ii. To locate goodness in thinking and doing the right thing, and to limit your desires to that.`),meditations.set("5.35",`5.35
If:
...
Where's the danger for the community?`),meditations.set("5.36",`5.36
...
And so you have to be an idiot as well?`),meditations.set("5.37",`5.37
I was once a fortunate man but at some point fortune abandoned me.
But true good fortune is what you make for yourself. Good fortune: good character, good intentions, and good actions.`),meditations.set("6.1",`6.1
Nature is pliable, obedient. And the logos that governs it has no reason to do evil. It knows no evil, does none, and causes harm to nothing. It dictates all beginnings and all endings.`),meditations.set("6.2",`6.2
...
There as well: “to do what needs doing.”`),meditations.set("6.3",`6.3
Look inward. Don’t let the true nature or value of anything elude you.`),meditations.set("6.4",`6.4
Before long, all existing things will be transformed, to rise like smoke (assuming all things become one), or be dispersed in fragments.`),meditations.set("6.5",`6.5
The logos knows where it stands, and what it has to do, and what it has to work with.`),meditations.set("6.6",`6.6
The best revenge is not to be like that.`),meditations.set("6.7",`6.7
To move from one unselfish action to another with God in mind.
Only there, delight and stillness.`),meditations.set("6.8",`6.8
The mind is that which is roused and directed by itself. It makes of itself what it chooses. It makes what it chooses of its own experience.`),meditations.set("6.9",`6.9
Everything is brought about by nature, not by anything beyond it, or within it, or apart from it.`),meditations.set("6.10",`6.10
...
Or suppose (ii): Reverence. Serenity. Faith in the power responsible.`),meditations.set("6.11",`6.11
When jarred, unavoidably, by circumstances, revert at once to yourself, and don’t lose the rhythm more than you can help. You’ll have a better grasp of the harmony if you keep on going back to it.`),meditations.set("6.12",`6.12
...
endurable.`),meditations.set("6.13",`6.13
...
(Compare Crates on Xenocrates.)`),meditations.set("6.14",`6.14
...
But those who revere that other mind—the one we all share, as humans and as citizens—aren’t interested in other things. Their focus is on the state of their own minds—to avoid all selfishness and illogic, and to work with others to achieve that goal.`),meditations.set("6.15",`6.15
...
(just yesterday or the day before), breathing it out like the air we exhale at each moment.`),meditations.set("6.16",`6.16
...
Because you’ll always be envious and jealous, afraid that people might come and take it all away from you. Plotting against those who have them—those things you prize. People who need those things are bound to be a mess—and bound to take out their frustrations on the gods. Whereas to respect your own mind—to prize it—will leave you satisfied with your own self, well integrated into your community and in tune with the gods as well—embracing what they allot you, and what they ordain.`),meditations.set("6.17",`6.17
The elements move upward, downward, in all directions.
The motion of virtue is different—deeper. It moves at a steady pace on a road hard to discern, and always forward.`),meditations.set("6.18",`6.18
...
But to recognize that if it’s humanly possible, you can do it too.`),meditations.set("6.20",`6.20
...
We need to do that in other areas. We need to excuse what our sparring partners do, and just keep our distance—without suspicion or hatred.`),meditations.set("6.21",`6.21
If anyone can refute me—show me I’m making a mistake or looking at things from the wrong perspective—I’ll gladly change. It’s the truth I’m after, and the truth never harmed anyone. What harms us is to persist in self-deceit and ignorance.`),meditations.set("6.22",`6.22
I do what is mine to do; the rest doesn’t disturb me. The rest is inanimate, or has no logos, or it wanders at random and has lost the road.`),meditations.set("6.23",`6.23
...
A single afternoon would be enough.`),meditations.set("6.24",`6.24
Alexander the Great and his mule driver both died and the same thing happened to both. They were absorbed alike into the life force of the world, or dissolved alike into atoms.`),meditations.set("6.25",`6.25
Think how much is going on inside you every second—in your soul, in your body. Why should it astonish you that so much more—everything that happens in that all-embracing unity, the world—is happening at the same time?`),meditations.set("6.26",`6.26
...
Remember—your responsibilities can be broken down into individual parts as well. Concentrate on those, and finish the job methodically—without getting stirred up or meeting anger with anger.`),meditations.set("6.27",`6.27
...
Then show them that. Prove it to them. Instead of losing your temper.`),meditations.set("6.28",`6.28
Death. The end of sense-perception, of being controlled by our emotions, of mental activity, of enslavement to our bodies.`),meditations.set("6.29",`6.29
Disgraceful: for the soul to give up when the body is still going strong.`),meditations.set("6.30",`6.30
...
So that when your time comes, your conscience will be as clear as his.`),meditations.set("6.31",`6.31
Awaken; return to yourself. Now, no longer asleep, knowing they were only dreams, clear-headed again, treat everything around you as a dream.`),meditations.set("6.32",`6.32
...
Which are within its own control. And it’s only the immediate ones that matter. Its past and future actions too are meaningless.`),meditations.set("6.33",`6.33
...
And if it’s normal, how can it be bad?`),meditations.set("6.34",`6.34
Thieves, perverts, parricides, dictators: the kind of pleasures they enjoy.`),meditations.set("6.35",`6.35
Have you noticed how professionals will meet the man on the street halfway but without compromising the logos of their trade? Should we as humans feel less responsibility to our logos than builders or pharmacists do? A logos we share with the divine?`),meditations.set("6.36",`6.36
...
are by-products of the good and beautiful. So don’t look at them as alien to what you revere, but focus on the source that all things spring from.`),meditations.set("6.37",`6.37
If you’ve seen the present then you’ve seen everything—
as it’s been since the beginning, as it will be forever. The same substance, the same form. All of it.`),meditations.set("6.38",`6.38
Keep reminding yourself of the way things are connected, of their relatedness. All things are implicated in one another and in sympathy with each other. This event is the consequence of some other one. Things push and pull on each other, and breathe together, and are one.`),meditations.set("6.39",`6.39
...
With real love.`),meditations.set("6.40",`6.40
...
But with naturally occurring things, the force that designed them is present within them and remains there. Which is why we owe it special reverence, with the recognition that if you live and act as it dictates, then everything in you is intelligently ordered. Just as everything in the world is.`),meditations.set("6.41",`6.41
...
to our own actions, we’d have no call to challenge God, or to treat other people as enemies.`),meditations.set("6.42",`6.42
...
But make sure it’s not the job Chrysippus speaks of: the bad line in the play, put there for laughs.`),meditations.set("6.43",`6.43
Does the sun try to do the rain’s work? Or Asclepius Demeter’s? And what about each of the stars—different, yet working in common?`),meditations.set("6.44",`6.44
...
My city and state are Rome—as Antoninus. But as a human being? The world. So for me, “good” can only mean what’s good for both communities.`),meditations.set("6.45",`6.45
Whatever happens to you is for the good of the world.
That would be enough right there. But if you look closely you’ll generally notice something else as well: whatever happens to a single person is for the good of others. (Good in the ordinary sense—as the world defines it.)`),meditations.set("6.46",`6.46
...
How much longer?`),meditations.set("6.47",`6.47
...
The only thing that isn’t worthless: to live this life out truthfully and rightly. And be patient with those who don’t.`),meditations.set("6.48",`6.48
...
It’s good to keep this in mind.`),meditations.set("6.49",`6.49
It doesn’t bother you that you weigh only x or y pounds and not three hundred. Why should it bother you that you have only x or y years to live and not more? You accept the limits placed on your body. Accept those placed on your time.`),meditations.set("6.50",`6.50
...
To try. And you succeeded. What you set out to do is accomplished.`),meditations.set("6.51",`6.51
Ambition means tying your well-being to what other people say or do.
Self-indulgence means tying it to the things that happen to you.
Sanity means tying it to your own actions.`),meditations.set("6.52",`6.52
You don’t have to turn this into something. It doesn’t have to upset you. Things can’t shape our decisions by themselves.`),meditations.set("6.53",`6.53
Practice really hearing what people say. Do your best to get inside their minds.`),meditations.set("6.54",`6.54
What injures the hive injures the bee.`),meditations.set("6.55",`6.55
If the crew talked back to the captain, or patients to their doctor, then whose authority would they accept? How could the passengers be kept safe or the patient healthy?`),meditations.set("6.56",`6.56
All those people who came into the world with me and have already left it.`),meditations.set("6.57",`6.57
Honey tastes bitter to a man with jaundice. People with rabies are terrified of water. And a child’s idea of beauty is a ball. Why does that upset you? Do you think falsehood is less powerful than bile or a rabid dog?`),meditations.set("6.58",`6.58
No one can keep you from living as your nature requires.
Nothing can happen to you that is not required by Nature.`),meditations.set("6.59",`6.59
The people they want to ingratiate themselves with, and the results, and the things they do in the process. How quickly it will all be erased by time. How much has been erased already.`),meditations.set("7.1",`7.1
...
Familiar, transient.`),meditations.set("7.2",`7.2
...
And life returns.`),meditations.set("7.3",`7.3
...
Surrounded as we are by all of this, we need to practice acceptance. Without disdain. But remembering that our own worth is measured by what we devote our energy to.`),meditations.set("7.4",`7.4
Focus on what is said when you speak and on what results from each action. Know what the one aims at, and what the other means.`),meditations.set("7.5",`7.5
...
Or I do the best I can with it, and collaborate with whoever can make use of it, to do what the community needs done. Because whatever I do—alone or with others—can aim at one thing only: what squares with those requirements.`),meditations.set("7.6",`7.6
So many who were remembered already forgotten, and those who remembered them long gone.`),meditations.set("7.7",`7.7
Don’t be ashamed to need help. Like a soldier storming a wall, you have a mission to accomplish. And if you’ve been wounded and you need a comrade to pull you up? So what?`),meditations.set("7.8",`7.8
Forget the future. When and if it comes, you’ll have the same resources to draw on—the same logos.`),meditations.set("7.9",`7.9
...
And one truth . . .
If this is indeed the culmination of one process, beings who share the same birth, the same logos.`),meditations.set("7.10",`7.10
All substance is soon absorbed into nature, all that animates it soon restored to the logos, all trace of them both soon covered over by time.`),meditations.set("7.11",`7.11
To a being with logos, an unnatural action is one that conflicts with the logos.`),meditations.set("7.12",`7.12
Straight, not straightened.`),meditations.set("7.13",`7.13
...
Or you could say “a part” (meros)—only a letter’s difference. But then you’re not really embracing other people. Helping them isn’t yet its own reward. You’re still seeing it only as The Right Thing To Do. You don’t yet realize who you’re really helping.`),meditations.set("7.14",`7.14
Let it happen, if it wants, to whatever it can happen to.
And what’s affected can complain about it if it wants. It doesn’t hurt me unless I interpret its happening as harmful to me. I can choose not to.`),meditations.set("7.15",`7.15
No matter what anyone says or does, my task is to be good. Like gold or emerald or purple repeating to itself, “No matter what anyone says or does, my task is to be emerald, my color undiminished.”`),meditations.set("7.16",`7.16
...
The mind in itself has no needs, except for those it creates itself. Is undisturbed, except for its own disturbances. Knows no obstructions, except those from within.`),meditations.set("7.17",`7.17
...
Yes, I know, it was only force of habit that brought you. No, I’m not angry with you. Just go away.)`),meditations.set("7.18",`7.18
...
Can’t you see? It’s just the same with you—and just as vital to nature.`),meditations.set("7.19",`7.19
...
For “Epictetus” read any person, and any thing.`),meditations.set("7.20",`7.20
My only fear is doing something contrary to human nature
—the wrong thing, the wrong way, or at the wrong time.`),meditations.set("7.21",`7.21
Close to forgetting it all, close to being forgotten.`),meditations.set("7.22",`7.22
...
They haven’t diminished your ability to choose.`),meditations.set("7.23",`7.23
...
It does the container no harm to be put together, and none to be taken apart.`),meditations.set("7.24",`7.24
Anger in the face is unnatural. † . . . † or in the end is put out for good, so that it can’t be rekindled. Try to conclude its unnaturalness from that. (If even the consciousness of acting badly has gone, why go on living?)`),meditations.set("7.25",`7.25
Before long, nature, which controls it all, will alter everything you see and use it as material for something else
—over and over again. So that the world is continually renewed.`),meditations.set("7.26",`7.26
When people injure you, ask yourself what good or harm they thought would come of it. If you understand that, you’ll feel sympathy rather than outrage or anger. Your sense of good and evil may be the same as theirs, or near it, in which case you have to excuse them. Or your sense of good and evil may differ from theirs. In which case they’re misguided and deserve your compassion. Is that so hard?`),meditations.set("7.27",`7.27
...
—that it would upset you to lose them.`),meditations.set("7.28",`7.28
Self-contraction: the mind’s requirements are satisfied by doing what we should, and by the calm it brings us.`),meditations.set("7.29",`7.29
...
Other people’s mistakes? Leave them to their makers.`),meditations.set("7.30",`7.30
To direct your thoughts to what is said. To focus the mind on what happens and what makes it happen.`),meditations.set("7.31",`7.31
...
31a. “ . . . all are relative,” it’s been said, “and in reality only atoms.” It’s enough to remember the first half: “all are relative.” “ Which is little enough. “`),meditations.set("7.32",`7.32
[On death:] If atoms, dispersed. If oneness, quenched or changed.`),meditations.set("7.33",`7.33
[On pain:] Unendurable pain brings its own end with it.
Chronic pain is always endurable: the intelligence maintains serenity by cutting itself off from the body, the mind remains undiminished. And the parts that pain affects—let them speak for themselves, if they can.`),meditations.set("7.34",`7.34
[On Ambition:] How their minds work, the things they long for and fear. Events like piles of sand, drift upon drift—
each one soon hidden by the next.`),meditations.set("7.35",`7.35
...
“ ‘Not in the least.’ ”`),meditations.set("7.36",`7.36
“Kingship: to earn a bad reputation by good deeds.”`),meditations.set("7.37",`7.37
Disgraceful: that the mind should control the face, should be able to shape and mold it as it pleases, but not shape and mold itself.`),meditations.set("7.38",`7.38
“And why should we feel anger at the world? As if the world would notice!”`),meditations.set("7.39",`7.39
“May you bring joy to us and those on high.”`),meditations.set("7.40",`7.40
“To harvest life like standing stalks of grain Grown and cut down in turn.”`),meditations.set("7.41",`7.41
“If I and my two children cannot move the gods The gods must have their reasons.”`),meditations.set("7.42",`7.42
“For what is just and good is on my side.”`),meditations.set("7.43",`7.43
No chorus of lamentation, no hysterics.`),meditations.set("7.44",`7.44
“Then the only proper response for me to make is this:
‘You are much mistaken, my friend, if you think that any man worth his salt cares about the risk of death and doesn’t concentrate on this alone: whether what he’s doing is right or wrong, and his behavior a good man’s or a bad one’s.’ ”`),meditations.set("7.45",`7.45
“It’s like this, gentlemen of the jury: The spot where a person decides to station himself, or wherever his commanding officer stations him—well, I think that’s where he ought to take his stand and face the enemy, and not worry about being killed, or about anything but doing his duty.”`),meditations.set("7.46",`7.46
“But, my good friend, consider the possibility that nobility and virtue are not synonymous with the loss or preservation of one’s life. Is it not possible that a real man should forget about living a certain number of years, and should not cling to life, but leave it up to the gods, accepting, as women say, that ‘no one can escape his fate,’ and turn his attention to how he can best live the life before him?”`),meditations.set("7.47",`7.47
To watch the courses of the stars as if you revolved with them. To keep constantly in mind how the elements alter into one another. Thoughts like this wash off the mud of life below.`),meditations.set("7.48",`7.48
[Plato has it right.] If you want to talk about people, you need to look down on the earth from above. Herds, armies, farms; weddings, divorces, births, deaths; noisy courtrooms, desert places; all the foreign peoples; holidays, days of mourning, market days . . . all mixed together, a harmony of opposites.`),meditations.set("7.49",`7.49
...
Which is why observing life for forty years is as good as a thousand. Would you really see anything new?`),meditations.set("7.50",`7.50
“ . . . Earth’s offspring back to earth But all that’s born of heaven To heaven returns again.”

Either that or the cluster of atoms pulls apart and one way or another the insensible elements disperse.`),meditations.set("7.51",`7.51
“. . . with food and drink and magic spells Seeking some novel way to frustrate death.”

51a. “To labor cheerfully and so endure The wind that blows from heaven.”`),meditations.set("7.52",`7.52
A better wrestler. But not a better citizen, a better person, a better resource in tight places, a better forgiver of faults.`),meditations.set("7.53",`7.53
Wherever something can be done as the logos shared by gods and men dictates, there all is in order. Where there is profit because our effort is productive, because it advances in step with our nature, there we have nothing to fear.`),meditations.set("7.54",`7.54
Everywhere, at each moment, you have the option:

• to accept this event with humility
• to treat this person as he should be treated
• to approach this thought with care, so that nothing irrational creeps in.`),meditations.set("7.55",`7.55
...
The mind that grasps this and steers straight ahead should be able to hold its own.`),meditations.set("7.56",`7.56
Think of yourself as dead. You have lived your life. Now take what’s left and live it properly.`),meditations.set("7.57",`7.57
To love only what happens, what was destined. No greater harmony.`),meditations.set("7.58",`7.58
...
Because you can use it, treat it as raw material. Just pay attention, and resolve to live up to your own expectations. In everything. And when faced with a choice, remember: our business is with things that really matter.`),meditations.set("7.59",`7.59
Dig deep; the water—goodness—is down there. And as long as you keep digging, it will keep bubbling up.`),meditations.set("7.60",`7.60
...
But it should come without effort.`),meditations.set("7.61",`7.61
Not a dancer but a wrestler: waiting, poised and dug in, for sudden assaults.`),meditations.set("7.62",`7.62
Look at who they really are, the people whose approval you long for, and what their minds are really like. Then you won’t blame the ones who make mistakes they can’t help, and you won’t feel a need for their approval. You will have seen the sources of both—their judgments and their actions.`),meditations.set("7.63",`7.63
“Against our will, our souls are cut off from truth.”
Truth, yes, and justice, self-control, kindness . . .
Important to keep this in mind. It will make you more patient with other people.`),meditations.set("7.64",`7.64
...
as drowsiness, fever, loss of appetite. . . . When you’re bothered by things like that, remind yourself: “I’m giving in to pain.”`),meditations.set("7.65",`7.65
Take care that you don’t treat inhumanity as it treats human beings.`),meditations.set("7.66",`7.66
...
Whether he was satisfied to treat men with justice and the gods with reverence and didn’t lose his temper unpredictably at evil done by others, didn’t make himself the slave of other people’s ignorance, didn’t treat anything that nature did as abnormal, or put up with it as an unbearable imposition, didn’t put his mind in his body’s keeping.`),meditations.set("7.67",`7.67
...
And this too: you don’t need much to live happily. And just because you’ve abandoned your hopes of becoming a great thinker or scientist, don’t give up on attaining freedom, achieving humility, serving others, obeying God.`),meditations.set("7.68",`7.68
...
While Adaptability adds, “You’re just what I was looking for.” Because to me the present is a chance for the exercise of rational virtue—civic virtue—in short, the art that men share with gods. Both treat whatever happens as wholly natural; not novel or hard to deal with, but familiar and easily handled.`),meditations.set("7.69",`7.69
Perfection of character: to live your last day, every day, without frenzy, or sloth, or pretense.`),meditations.set("7.70",`7.70
...
And you—on the verge of death—you still refuse to care for them, although you’re one of them yourself.`),meditations.set("7.71",`7.71
It’s silly to try to escape other people’s faults. They are inescapable. Just try to escape your own.`),meditations.set("7.72",`7.72
Whenever the force that makes us rational and social encounters something that is neither, then it can reasonably regard it as inferior.`),meditations.set("7.73",`7.73
You’ve given aid and they’ve received it. And yet, like an idiot, you keep holding out for more: to be credited with a Good Deed, to be repaid in kind. Why?`),meditations.set("7.74",`7.74
No one objects to what is useful to him.
To be of use to others is natural.
Then don’t object to what is useful to you—being of use.`),meditations.set("7.75",`7.75
...
A source of serenity in more situations than one.`),meditations.set("8.1",`8.1
...
—What principles?
Those to do with good and evil. That nothing is good except what leads to fairness, and self-control, and courage, and free will. And nothing bad except what does the opposite.`),meditations.set("8.2",`8.2
For every action, ask: How does it affect me? Could I change my mind about it?
But soon I’ll be dead, and the slate’s empty. So this is the only question: Is it the action of a responsible being, part of society, and subject to the same decrees as God?`),meditations.set("8.3",`8.3
...
The others? Nothing but anxiety and enslavement.`),meditations.set("8.4",`8.4
You can hold your breath until you turn blue, but they’ll still go on doing it.`),meditations.set("8.5",`8.5
...
The second step: Concentrate on what you have to do. Fix your eyes on it. Remind yourself that your task is to be a good human being; remind yourself what nature demands of people. Then do it, without hesitation, and speak the truth as you see it. But with kindness. With humility. Without hypocrisy.`),meditations.set("8.6",`8.6
...
Everything is familiar. Even the proportions are unchanged.`),meditations.set("8.7",`8.7
...
this weighed against that.`),meditations.set("8.8",`8.8
No time for reading. For controlling your arrogance, yes.

For overcoming pain and pleasure, yes. For outgrowing ambition, yes. For not feeling anger at stupid and unpleasant people—even for caring about them—for that, yes.`),meditations.set("8.9",`8.9
Don’t be overheard complaining about life at court. Not even to yourself.`),meditations.set("8.10",`8.10
...
So it cannot be to your benefit, or good.`),meditations.set("8.11",`8.11
What is this, fundamentally? What is its nature and substance, its reason for being? What is it doing in the world? How long is it here for?`),meditations.set("8.12",`8.12
When you have trouble getting out of bed in the morning, remember that your defining characteristic—what defines a human being—is to work with others. Even animals know how to sleep. And it’s the characteristic activity that’s the more natural one—more innate and more satisfying.`),meditations.set("8.13",`8.13
Apply them constantly, to everything that happens:

Physics. Ethics. Logic.`),meditations.set("8.14",`8.14
...
In fact, I’ll remind myself that he has no real choice.`),meditations.set("8.15",`8.15
Remember: you shouldn’t be surprised that a fig tree produces figs, nor the world what it produces. A good doctor isn’t surprised when his patients have fevers, or a helmsman when the wind blows against him.`),meditations.set("8.16",`8.16
Remember that to change your mind and to accept correction are free acts too. The action is yours, based on your own will, your own decision—and your own mind.`),meditations.set("8.17",`8.17
...
No pointless actions.`),meditations.set("8.18",`8.18
What dies doesn’t vanish. It stays here in the world, transformed, dissolved, as parts of the world, and of you.
Which are transformed in turn—without grumbling.`),meditations.set("8.19",`8.19
Everything is here for a purpose, from horses to vine shoots. What’s surprising about that? Even the sun will tell you, “I have a purpose,” and the other gods as well. And why were you born? For pleasure? See if that answer will stand up to questioning.`),meditations.set("8.20",`8.20
...
And the same for a candle.`),meditations.set("8.21",`8.21
...
And the whole earth a mere point in space.`),meditations.set("8.22",`8.22
Stick to what’s in front of you—idea, action, utterance.
22a. This is what you deserve. You could be good today. But instead you choose tomorrow.`),meditations.set("8.23",`8.23
What I do? I attribute it to human beneficence.
What is done to me? I accept it—and attribute it to the gods, and that source from which all things together flow.`),meditations.set("8.24",`8.24
Like the baths—oil, sweat, dirt, grayish water, all of it disgusting.
The whole of life, all of the visible world.`),meditations.set("8.25",`8.25
...
So remember: your components will be scattered too, the life within you quenched. Or marching orders and another posting.`),meditations.set("8.26",`8.26
Joy for humans lies in human actions.
Human actions: kindness to others, contempt for the senses, the interrogation of appearances, observation of nature and of events in nature.`),meditations.set("8.27",`8.27
Three relationships:

i. with the body you inhabit;
ii. with the divine, the cause of everything in all things;
iii. with the people around you.`),meditations.set("8.28",`8.28
...
All our decisions, urges, desires, aversions lie within. No evil can touch them.`),meditations.set("8.29",`8.29
To erase false perceptions, tell yourself: I have it in me to keep my soul from evil, lust and all confusion. To see things as they are and treat them as they deserve. Don’t overlook this innate ability.`),meditations.set("8.30",`8.30
To speak to the Senate—or anyone—in the right tone, without being overbearing. To choose the right words.`),meditations.set("8.31",`8.31
...
That line they write on tombs—“last surviving descendant.” Consider their ancestors’ anxiety—that there be a successor. But someone has to be the last. There, too, the death of a whole house.`),meditations.set("8.32",`8.32
...
But if you accept the obstacle and work with what you’re given, an alternative will present itself—another piece of what you’re trying to assemble. Action by action.`),meditations.set("8.33",`8.33
To accept it without arrogance, to let it go with indifference.`),meditations.set("8.34",`8.34
...
Just mark off its limits. And if your mind tries to claim that it can’t hold out against that . . . well, then, heap shame upon it.`),meditations.set("8.37",`8.37
...
And even if it did, would the mourners live forever? Were they, too, not fated to grow old and then die? And when that happened, what would the emperors do?`),meditations.set("8.38",`8.38
The stench of decay. Rotting meat in a bag.
Look at it clearly. If you can.`),meditations.set("8.39",`8.39
“To the best of my judgment, when I look at the human character I see no virtue placed there to counter justice. But I see one to counter pleasure: self-control.”`),meditations.set("8.40",`8.40
Stop perceiving the pain you imagine and you’ll remain completely unaffected.
—“You?”
Your logos.
—But I’m not just logos.
Fine. Just don’t let the logos be injured. If anything else is, let it decide that for itself.`),meditations.set("8.41",`8.41
...
Do pain and pleasure have their hooks in you? Let the senses deal with it. Are there obstacles to your action? If you failed to reckon with the possibility, then that would harm you, as a rational being. But if you use common sense, you haven’t been harmed or even obstructed. No one can obstruct the operations of the mind. Nothing can get at them—not fire or steel, not tyrants, not abuse—nothing. As long as it’s “a sphere . . . in perfect stillness.”`),meditations.set("8.42",`8.42
I have no right to do myself an injury. Have I ever injured anyone else if I could avoid it?`),meditations.set("8.43",`8.43
People find pleasure in different ways. I find it in keeping my mind clear. In not turning away from people or the things that happen to them. In accepting and welcoming everything I see. In treating each thing as it deserves.`),meditations.set("8.44",`8.44
Give yourself a gift: the present moment.
People out for posthumous fame forget that the Generations To Come will be the same annoying people they know now.
And just as mortal. What does it matter to you if they say x about you, or think y?`),meditations.set("8.45",`8.45
...
Is there any reason why my soul should suffer and be degraded—miserable, tense, huddled, frightened? How could there be?`),meditations.set("8.46",`8.46
...
Nothing that can happen is unusual or unnatural, and there’s no sense in complaining. Nature does not make us endure the unendurable.`),meditations.set("8.47",`8.47
...
Then depart, with a good conscience, as if you’d done it, embracing the obstacles too.`),meditations.set("8.48",`8.48
...
The mind without passions is a fortress. No place is more secure. Once we take refuge there we are safe forever. Not to see this is ignorance. To see it and not seek safety means misery.`),meditations.set("8.49",`8.49
...
Or extrapolate. From a knowledge of all that can happen in the world.`),meditations.set("8.50",`8.50
...
Through patience, honesty, humility.`),meditations.set("8.52",`8.52
...
And what are we to make of anyone who cares about the applause of such people, who don’t know where or who they are?`),meditations.set("8.53",`8.53
You want praise from people who kick themselves every fifteen minutes, the approval of people who despise themselves. (Is it a sign of self-respect to regret nearly everything you do?)`),meditations.set("8.54",`8.54
To join ourselves not just to the air surrounding us, through breath, but to the reason that embraces all things, through thought. Reason is just as omnipresent, just as widely diffused in those who accept it as air is in those who breathe.`),meditations.set("8.55",`8.55
The existence of evil does not harm the world. And an individual act of evil does not harm the victim. Only one person is harmed by it—and he can stop being harmed as soon as he decides to.`),meditations.set("8.56",`8.56
...
—for my happiness to rest with someone else.`),meditations.set("8.57",`8.57
...
What doesn’t transmit light creates its own darkness.`),meditations.set("8.58",`8.58
Fear of death is fear of what we may experience. Nothing at all, or something quite new. But if we experience nothing, we can experience nothing bad. And if our experience changes, then our existence will change with it—change, but not cease.`),meditations.set("8.59",`8.59
People exist for one another. You can instruct or endure them.`),meditations.set("8.60",`8.60
An arrow has one motion and the mind another. Even when pausing, even when weighing conclusions, the mind is moving forward, toward its goal.`),meditations.set("8.61",`8.61
To enter others’ minds and let them enter yours.`),meditations.set("9.1",`9.1
...
Diseases like that can only threaten your life; this one attacks your humanity.`),meditations.set("9.3",`9.3
...
“Come quickly. Before I start to forget myself, like them.”`),meditations.set("9.4",`9.4
To do harm is to do yourself harm. To do an injustice is to do yourself an injustice—it degrades you.`),meditations.set("9.5",`9.5
And you can also commit injustice by doing nothing.`),meditations.set("9.6",`9.6
Objective judgment, now, at this very moment.
Unselfish action, now, at this very moment.
Willing acceptance—now, at this very moment—of all external events.
That’s all you need.`),meditations.set("9.7",`9.7
Blot out your imagination. Turn your desire to stone.
Quench your appetites. Keep your mind centered on itself.`),meditations.set("9.8",`9.8
Animals without the logos are assigned the same soul, and those who have the logos share one too—a rational one. Just as all earthly creatures share one earth. Just as we all see by the same light, and breathe the same air—all of us who see and breathe.`),meditations.set("9.9",`9.9
...
Concrete objects can pull free of the earth more easily than humans can escape humanity.`),meditations.set("9.10",`9.10
Humanity, divinity, and the world: all of them bearing fruit. Each fruitful in its season. Normally we limit the word to vines and other plants. Unnecessarily. The fruit of the logos nourishes both us and it. And other things spring from it too—of the same species as the logos itself.`),meditations.set("9.11",`9.11
...
And yours, too, if you wanted. What’s stopping you?`),meditations.set("9.12",`9.12
Work:
Not to rouse pity, not to win sympathy or admiration. Only this:
Activity.

Stillness.
As the logos of the state requires.`),meditations.set("9.13",`9.13
Today I escaped from anxiety. Or no, I discarded it, because it was within me, in my own perceptions—not outside.`),meditations.set("9.14",`9.14
Known by long experience, limited in life span, debased in substance—all of it.
Now as then, in the time of those we buried.`),meditations.set("9.15",`9.15
...
The mind does.`),meditations.set("9.16",`9.16
Not being done to, but doing—the source of good and bad for rational and political beings. Where their own goodness and badness is found—not in being done to, but in doing.`),meditations.set("9.17",`9.17
A rock thrown in the air. It loses nothing by coming down, gained nothing by going up.`),meditations.set("9.18",`9.18
Enter their minds, and you’ll find the judges you’re so afraid of—and how judiciously they judge themselves.`),meditations.set("9.19",`9.19
Everything in flux. And you too will alter in the whirl and perish, and the world as well.`),meditations.set("9.20",`9.20
Leave other people’s mistakes where they lie.`),meditations.set("9.21",`9.21
...
Then neither will the close of your life be—its ending and transformation.`),meditations.set("9.22",`9.22
...
from`),meditations.set("9.23",`9.23
You participate in a society by your existence. Then participate in its life through your actions—all your actions.
Any action not directed toward a social end (directly or indirectly) is a disturbance to your life, an obstacle to wholeness, a source of dissension. Like the man in the Assembly—a faction to himself, always out of step with the majority.`),meditations.set("9.24",`9.24
Childish tantrums, children’s games, “spirits carrying corpses”; “Odysseus in the Underworld” saw more real life.`),meditations.set("9.25",`9.25
Identify its purpose—what makes it what it is—and examine that. (Ignore its concrete form.) Then calculate the length of time that such a thing was meant to last.`),meditations.set("9.26",`9.26
Endless suffering—all from not allowing the mind to do its job. Enough.`),meditations.set("9.27",`9.27
...
But you do have to wish him well. He’s your closest relative. The gods assist him just as they do you—by signs and dreams and every other way—to get the things he wants.`),meditations.set("9.28",`9.28
...
Think about them: the waves of change and alteration, endlessly breaking. And see our brief mortality for what it is.`),meditations.set("9.29",`9.29
...
Don’t tempt me to presumption.`),meditations.set("9.30",`9.30
...
That to be remembered is worthless. Like fame. Like everything.`),meditations.set("9.31",`9.31
...
What you were born to do.`),meditations.set("9.32",`9.32
...
each part of every thing; the narrow space between our birth and death; the infinite time before; the equally unbounded time that follows.`),meditations.set("9.33",`9.33
All that you see will soon have vanished, and those who see it vanish will vanish themselves, and the ones who reached old age have no advantage over the untimely dead.`),meditations.set("9.34",`9.34
What their minds are like. What they work at. What evokes their love and admiration.
Imagine their souls stripped bare. And their vanity. To suppose that their disdain could harm anyone—or their praise help them.`),meditations.set("9.35",`9.35
...
That things happen for the worst and always will, that the gods have no power to regulate them, and the world is condemned to never-ending evil—how can you say that?`),meditations.set("9.36",`9.36
...
And the same with our living breath—transformed from one thing to another.`),meditations.set("9.37",`9.37
...
Even now.
A hundred years or three. . . . No difference.`),meditations.set("9.38",`9.38
If they’ve injured you, then they’re the ones who suffer for it.
But have they?`),meditations.set("9.39",`9.39
...
dishonest?
Are you one of the herd? or grazing like one?`),meditations.set("9.40",`9.40
...
Redirect your prayers like that, and watch what happens.`),meditations.set("9.41",`9.41
...
Concentrate on what you’re doing, and what you’re doing it with.`),meditations.set("9.42",`9.42
...
Will you ever take your stand as a fellow citizen with gods and human beings, blaming no one, deserving no one’s censure?`),meditations.set("10.2",`10.2
...
Follow these guidelines and don’t waste time on anything else.`),meditations.set("10.3",`10.3
...
In your interest, or in your nature.`),meditations.set("10.4",`10.4
If they’ve made a mistake, correct them gently and show them where they went wrong. If you can’t do that, then the blame lies with you. Or no one.`),meditations.set("10.5",`10.5
Whatever happens to you has been waiting to happen since the beginning of time. The twining strands of fate wove both of them together: your own existence and the things that happen to you.`),meditations.set("10.6",`10.6
...
That’s not what we’re talking about here.`),meditations.set("10.8",`10.8
...
For figs to do what figs were meant to do—and dogs, and bees . . . and people.`),meditations.set("10.9",`10.9
...
Seriousness? Or understanding individual things—their nature and substance, their place in the world, their life span, their composition, who can possess them, whose they are to give and to receive?`),meditations.set("10.10",`10.10
Spiders are proud of catching flies, men of catching hares, fish in a net, boars, bears, Sarmatians . . .
Criminal psychology.`),meditations.set("10.11",`10.11
...
12a. To follow the logos in all things is to be relaxed and energetic, joyful and serious at once.`),meditations.set("10.13",`10.13
...
Forgotten their behavior, their fears, their desires, their thefts and depredations—not physical ones, but those committed by what should be highest in them? What creates, when it chooses, loyalty, humility, truth, order, well-being.`),meditations.set("10.14",`10.14
Nature gives and nature takes away. Anyone with sense and humility will tell her, “Give and take as you please,” not out of defiance, but out of obedience and goodwill.`),meditations.set("10.15",`10.15
...
(Better than living like this.)`),meditations.set("10.16",`10.16
To stop talking about what the good man is like, and just be one.`),meditations.set("10.17",`10.17
Continual awareness of all time and space, of the size and life span of the things around us. A grape seed in infinite space. A half twist of a corkscrew against eternity.`),meditations.set("10.18",`10.18
...
Or that everything was born to die.`),meditations.set("10.19",`10.19
...
—and the things they’ll submit to again before very long.`),meditations.set("10.20",`10.20
Each of us needs what nature gives us, when nature gives it.`),meditations.set("10.21",`10.21
...
(And isn’t that what we mean by “inclined to happen”?)`),meditations.set("10.22",`10.22
Possibilities:
...
Those are the only options. Reason for optimism.`),meditations.set("10.23",`10.23
Keep always before you that “this is no different from an empty field,” and the things in it are the same as on a mountaintop, on the seashore, wherever. Plato gets to the heart of it: “fencing a sheepfold in the mountains, and milking goats or sheep.”`),meditations.set("10.24",`10.24
...
Melted into flesh and blended with it, so that it shares its urges?`),meditations.set("10.25",`10.25
...
To feel grief, anger or fear is to try to escape from something decreed by the ruler of all things, now or in the past or in the future. And that ruler is law, which governs what happens to each of us. To feel grief or anger or fear is to become a fugitive—a fugitive from justice.`),meditations.set("10.26",`10.26
...
To look at these things going on silently and see the force that drives them. As we see the force that pushes things and pulls them. Not with our eyes, but just as clearly.`),meditations.set("10.27",`10.27
To bear in mind constantly that all of this has happened before. And will happen again—the same plot from beginning to end, the identical staging. Produce them in your mind, as you know them from experience or from history: the court of Hadrian, of Antoninus. The courts of Philip, Alexander, Croesus. All just the same. Only the people different.`),meditations.set("10.28",`10.28
...
That everything has to submit. But only rational beings can do so voluntarily.`),meditations.set("10.29",`10.29
Stop whatever you’re doing for a moment and ask yourself: Am I afraid of death because I won’t be able to do this anymore?`),meditations.set("10.30",`10.30
...
Or remove the compulsion, if you can.`),meditations.set("10.31",`10.31
...
So keep at it, until it’s fully digested. As a strong stomach digests whatever it eats. As a blazing fire takes whatever you throw on it, and makes it light and flame.`),meditations.set("10.32",`10.32
...
Simply resolve not to go on living if you aren’t. It would be contrary to the logos.`),meditations.set("10.33",`10.33
...
And keep in mind that nothing can harm one of nature’s citizens except what harms the city he belongs to. And nothing harms that city except what harms its law. And there is no so-called misfortune that can do that. So long as the law is safe, so is the city—and the citizen.`),meditations.set("10.34",`10.34
...
Before long, darkness. And whoever buries you mourned in their turn.`),meditations.set("10.35",`10.35
...
“Everyone must approve of me” is like eyes that can only stand pale colors, or teeth that can handle only mush.`),meditations.set("10.36",`10.36
...
Affection for its neighbors. Truthfulness. Humility. Not to place anything above itself—which is characteristic of law as well. No difference here between the logos of rationality and that of justice.`),meditations.set("11.2",`11.2
...
Apply this to life as a whole.`),meditations.set("11.3",`11.3
The resolute soul:
...
Without dramatics.`),meditations.set("11.4",`11.4
Have I done something for the common good? Then I share in the benefits.
To stay centered on that. Not to give up.`),meditations.set("11.5",`11.5
“And your profession?” “Goodness.” (And how is that to be achieved, except by thought—about the world, about the nature of people?)`),meditations.set("11.6",`11.6
...
“One trunk, two minds.” As the gardeners put it.`),meditations.set("11.9",`11.9
...
Because anger, too, is weakness, as much as breaking down and giving up the struggle. Both are deserters: the man who breaks and runs, and the one who lets himself be alienated from his fellow humans.`),meditations.set("11.10",`11.10
...
For how could we do what justice requires if we are distracted by things that don’t matter, if we are naive, gullible, inconstant?`),meditations.set("11.11",`11.11
...
Suspend judgment about them. And at once they will lie still, and you will be freed from fleeing and pursuing.`),meditations.set("11.12",`11.12
The soul as a sphere in equilibrium: Not grasping at things beyond it or retreating inward. Not fragmenting outward, not sinking back on itself, but ablaze with light and looking at the truth, without and within.`),meditations.set("11.13",`11.13
Someone despises me.
...
As long as you do what’s proper to your nature, and accept what the world’s nature has in store—as long as you work for others’ good, by any and all means—what is there that can harm you?`),meditations.set("11.14",`11.14
They flatter one another out of contempt, and their desire to rule one another makes them bow and scrape.`),meditations.set("11.15",`11.15
...
False friendship is the worst. Avoid it at all costs. If you’re honest and straightforward and mean well, it should show in your eyes. It should be unmistakable.`),meditations.set("11.16",`11.16
To live a good life:
...
None of us is forbidden to pursue our own good.`),meditations.set("11.17",`11.17
Source and substance of each thing. What it changes into, and what it’s like transformed; that nothing can harm it.`),meditations.set("11.18",`11.18
...
x. That to expect bad people not to injure others is crazy. It’s to ask the impossible. And to let them behave like that to other people but expect them to exempt you is arrogant—the act of a tyrant.`),meditations.set("11.19",`11.19
...
And the fourth reason for self-reproach: that the more divine part of you has been beaten and subdued by the degraded mortal part—the body and its stupid selfindulgence.`),meditations.set("11.20",`11.20
...
That too is an element of coexistence and a prerequisite for justice.`),meditations.set("11.21",`11.21
“If you don’t have a consistent goal in life, you can’t live it in a consistent way.”

Unhelpful, unless you specify a goal.
There is no common benchmark for all the things that people think are good—except for a few, the ones that affect us all. So the goal should be a common one—a civic one. If you direct all your energies toward that, your actions will be consistent. And so will you.`),meditations.set("11.22",`11.22
The town mouse and the country mouse. Distress and agitation of the town mouse.`),meditations.set("11.23",`11.23
Socrates used to call popular beliefs “the monsters under the bed”—only useful for frightening children with.`),meditations.set("11.24",`11.24
At festivals the Spartans put their guests’ seats in the shade, but sat themselves down anywhere.`),meditations.set("11.25",`11.25
Socrates declining Perdiccas’s invitation “so as to avoid dying a thousand deaths” (by accepting a favor he couldn’t pay back).`),meditations.set("11.26",`11.26
This advice from Epicurean writings: to think continually of one of the men of old who lived a virtuous life.`),meditations.set("11.27",`11.27
The Pythagoreans tell us to look at the stars at daybreak.
To remind ourselves how they complete the tasks assigned them—always the same tasks, the same way. And their order, purity, nakedness. Stars wear no concealment.`),meditations.set("11.28",`11.28
Socrates dressed in a towel, the time Xanthippe took his cloak and went out. The friends who were embarrassed and avoided him when they saw him dressed like that, and what Socrates said to them.`),meditations.set("11.29",`11.29
Mastery of reading and writing requires a master. Still more so life.`),meditations.set("11.30",`11.30
“. . . For you/Are but a slave and have no claim to logos.”`),meditations.set("11.31",`11.31
“But my heart rejoiced.”`),meditations.set("11.32",`11.32
“And jeer at virtue with their taunts and sneers.”`),meditations.set("11.33",`11.33
Stupidity is expecting figs in winter, or children in old age.`),meditations.set("11.34",`11.34
As you kiss your son good night, says Epictetus, whisper to yourself, “He may be dead in the morning.”
Don’t tempt fate, you say.
By talking about a natural event? Is fate tempted when we speak of grain being reaped?`),meditations.set("11.35",`11.35
Grapes.
Unripe . . . ripened . . . then raisins.

Constant transitions.
Not the “not” but the “not yet.”`),meditations.set("11.36",`11.36
“No thefts of free will reported.”[—Epictetus.]`),meditations.set("11.37",`11.37
“We need to master the art of acquiescence. We need to pay attention to our impulses, making sure they don’t go unmoderated, that they benefit others, that they’re worthy of us. We need to steer clear of desire in any form and not try to avoid what’s beyond our control.”`),meditations.set("11.38",`11.38
“This is not a debate about just anything,” he said, “but about sanity itself.”`),meditations.set("11.39",`11.39
...
—We already have.
Then why all this squabbling?`),meditations.set("12.1",`12.1
...
(which means the present) . . . then you can spend the time you have left in tranquillity. And in kindness. And at peace with the spirit within you.`),meditations.set("12.4",`12.4
...
—and prohibited us from concealing our thoughts or imagining anything without immediately shouting it out, we wouldn’t make it through a single day. That’s how much we value other people’s opinions—instead of our own.`),meditations.set("12.5",`12.5
...
And if they are, how could they have carelessly overlooked something so unfair—so illogical—in setting up the world?`),meditations.set("12.6",`12.6
Practice even what seems impossible.
The left hand is useless at almost everything, for lack of practice. But it guides the reins better than the right. From practice.`),meditations.set("12.7",`12.7
The condition of soul and body when death comes for us.
Shortness of life.
Vastness of time before and after.
Fragility of matter.`),meditations.set("12.8",`12.8
...
That it’s all in how you perceive it.`),meditations.set("12.9",`12.9
The student as boxer, not fencer.
The fencer’s weapon is picked up and put down again.
The boxer’s is part of him. All he has to do is clench his fist.`),meditations.set("12.10",`12.10
To see things as they are. Substance, cause and purpose.`),meditations.set("12.11",`12.11
The freedom to do only what God wants, and accept whatever God sends us.
11a. What it’s made of.`),meditations.set("12.12",`12.12
The gods are not to blame. They do nothing wrong, on purpose or by accident. Nor men either; they don’t do it on purpose. No one is to blame.`),meditations.set("12.13",`12.13
The foolishness of people who are surprised by anything that happens. Like travelers amazed at foreign customs.`),meditations.set("12.14",`12.14
...
If it’s confusion and anarchy, then be grateful that on this raging sea you have a mind to guide you. And if the storm should carry you away, let it carry off flesh, breath and all the rest, but not the mind. Which can’t be swept away.`),meditations.set("12.15",`12.15
The lamp shines until it is put out, without losing its gleam, and yet in you it all gutters out so early—truth, justice, self-control?`),meditations.set("12.16",`12.16
...
If you’re still angry, then get to work on that.`),meditations.set("12.17",`12.17
If it’s not right, don’t do it. If it’s not true, don’t say it.
Let your intention be < . . . >`),meditations.set("12.18",`12.18
At all times, look at the thing itself—the thing behind the appearance—and unpack it by analysis:

• cause
• substance
• purpose
• and the length of time it exists.`),meditations.set("12.19",`12.19
It’s time you realized that you have something in you more powerful and miraculous than the things that affect you and make you dance like a puppet.
What’s in my thoughts at this moment? Fear? Jealousy?

Desire? Feelings like that?`),meditations.set("12.20",`12.20
To undertake nothing:

i. at random or without a purpose;
ii. for any reason but the common good.`),meditations.set("12.21",`12.21
That before long you’ll be no one, and nowhere. Like all the things you see now. All the people now living.
Everything’s destiny is to change, to be transformed, to perish. So that new things can be born.`),meditations.set("12.22",`12.22
It’s all in how you perceive it. You’re in control. You can dispense with misperception at will, like rounding the point. Serenity, total calm, safe anchorage.`),meditations.set("12.23",`12.23
...
This is how we become godlike—following God’s path, and reason’s goals.`),meditations.set("12.24",`12.24
...
Arrogance . . . about this?`),meditations.set("12.25",`12.25
Throw out your misperceptions and you’ll be fine. (And who’s stopping you from throwing them out?)`),meditations.set("12.26",`12.26
...
That the present is all we have to live in. Or to lose.`),meditations.set("12.27",`12.27
...
And how much more philosophical it would be to take what we’re given and show uprightness, self-control, obedience to God, without making a production of it. There’s nothing more insufferable than people who boast about their own humility.`),meditations.set("12.28",`12.28
...
from having felt their power, over and over.`),meditations.set("12.29",`12.29
...
What else could it be but to live life fully—to pay out goodness like the rings of a chain, without the slightest gap.`),meditations.set("12.30",`12.30
Singular, not plural:
...
But intelligence is uniquely drawn toward what is akin to it, and joins with it inseparably, in shared awareness.`),meditations.set("12.31",`12.31
...
to grieve because death deprives us of them—is an obstacle.`),meditations.set("12.32",`12.32
...
Keep all that in mind, and don’t treat anything as important except doing what your nature demands, and accepting what Nature sends you.`),meditations.set("12.33",`12.33
How the mind conducts itself. It all depends on that. All the rest is within its power, or beyond its control—corpses and smoke.`),meditations.set("12.34",`12.34
An incentive to treat death as unimportant: even people whose only morality is pain and pleasure can manage that much.`),meditations.set("12.35",`12.35
...
. . . then death shouldn’t scare you.`),meditations.set("12.36",`12.36
...
So make your exit with grace—the same grace shown to you.`);let meditationKeys=[...meditations.keys()];function getAllMeditationKeys(n){let t=[],e;for(e=0;e<ExplorerImp.map.size;e++){const s=ExplorerImp.keys[e];if(s==ExplorerImp.currentKey)continue;ExplorerImp.map.get(s).toLowerCase().includes(n)&&t.push(s)}return t}ExplorerImp={map:meditations,keys:meditationKeys,count:1,onDefaultActionActivated:function(){setRandomDiscovery()},onSetDiscovery:function(t){const n=t[0];let e=document.getElementById("explorer-text");typeof e!="undefined"&&e!==null&&(e.innerText=n.discovery)},generateShareData:function(t){const e=t[0];return{title:`Marcus Aurelius's Meditation ${e.key}`,text:e.discovery,url:window.location.href}},onClickWord:function(e){const t=pickOne(getAllMeditationKeys(e));setDiscovery(t)}}