...
His searching questions at meetings. A kind of singlemindedness, almost, never content with first impressions, or
...
someone, to turn your back on him: these are obstructions.`,
    `2.2
Whatever this is that I am, it is flesh and a little spirit and
...
kick against fate and the present, and to mistrust the future.`,
    `2.3
What is divine is full of Providence. Even chance is not
...
this, that’s all even the gods can ask of you.`,
    `2.6
Yes, keep on degrading yourself, soul. But soon your
...
toward are wasting their time—even when hard at work.`,
    `2.8
Ignoring what goes on in other people’s souls—no one
...
is mastered by pleasure, seems somehow more selfindulgent, less manly in his sins. Theophrastus is right, and
...
To stand up straight—not straightened.`,
    `3.6
If, at some point in your life, you should come across
...
in.`,
    `3.8
The mind of one set straight and purified: no pus, no dirt,
no scabs.
...
submission to the divine.`,
    `3.10
Forget everything else. Keep hold of this alone and
...
alike of themselves and those long dead.`,
    `3.11
To the stand-bys above, add this one: always to define
...
acceptance, in peaceful unity with what must be.`,
    `4.1
Our inward power, when it obeys nature, reacts to events
...
consumed by it—and makes it burn still higher.`,
    `4.2
No random actions, none not based on underlying
principles.`,
    `4.3
...
perception.”`,
    `4.4
If thought is something we share, then so is reason—what
...
So thought must derive from somewhere else as well.`,
    `4.5
Death: something like birth, a natural mystery, elements
that split and recombine.

Not an embarrassing thing. Not an offense to reason, or our
nature.`,
    `4.6
That sort of person is bound to do that. You might as well
...
Keep to it in everything you do.`,
    `4.11
Not what your enemy sees and hopes that you will, but
what’s really there.`,
    `4.12
Two kinds of readiness are constantly needed: (i) to do
...
By being changed.`,
    `4.15
Many lumps of incense on the same altar. One crumbles
now, one later, but it makes no difference.`,
    `4.16
Now they see you as a beast, a monkey. But in a week
...
good.`,
    `4.18
The tranquillity that comes when you stop caring what
...
straight for the finish line, unswerving.`,
    `4.19
People who are excited by posthumous fame forget that
...
on someone’s words in the future. “`,
    `4.20
Beautiful things of any kind are beautiful in themselves
...
with justice and see things as they are.`,
    `4.23
To the world: Your harmony is mine. Whatever time you
...
well. To eliminate the unnecessary actions that follow.`,
    `4.25
And then you might see what the life of the good man is
...
Unrestrained moderation.`,
    `4.27
An ordered world or a mishmash. But still an order. Can
there be order within you and not in everything else? In
things so different, so dispersed, so intertwined?`,
    `4.28
Character: dark, womanish, obstinate. Wolf, sheep, child,
fool, cheat, buffoon, salesman, tyrant.`,
    `4.29
Alien: (n.) one who doesn’t know what the world
...
way through life—no one’s master and no one’s slave.`,
    `4.32
The age of Vespasian, for example. People doing the
...
spring.`,
    `4.34
Hand yourself over to Clotho voluntarily, and let her spin
...
unnatural.`,
    `4.40
The world as a living being—one nature, one soul. Keep
...
“A little wisp of soul carrying a corpse.”—Epictetus.`,
    `4.42
There is nothing bad in undergoing change—or good in
emerging from it.`,
    `4.43
Time is a river, a violent current of events, glimpsed

once and already carried past us, and another follows and is
gone.`,
    `4.44
Everything that happens is as simple and familiar as the
rose in spring, the fruit in summer: disease, death,
blasphemy, conspiracy . . . everything that makes stupid
people happy or angry.`,
    `4.45
What follows coheres with what went before. Not like a
...
Not a mere sequence, but an astonishing concordance.`,
    `4.46
Remember Heraclitus: “When earth dies, it becomes
water; water, air; air, fire; and back to the beginning.”
“Those who have forgotten where the road leads.”
“They are at odds with what is all around them”—the alldirecting logos. And “they find alien what they meet with
every day.”
...
we have been told.`,
    `4.47
Suppose that a god announced that you were going to die
...
small.`,
    `4.48
Don’t let yourself forget how many doctors have died,
...
endure it and prevail is great good fortune.`,
    `4.50
A trite but effective tactic against the fear of death: think
...
effort?`,
    `5.2
To shrug it all off and wipe it clean—every annoyance and
distraction—and reach utter stillness.
Child’s play.`,
    `5.3
If an action or utterance is appropriate, then it’s
...
own nature, and follow Nature—along the road they share.`,
    `5.4
I walk through what is natural, until the time comes to sink
...
Either no prayers at all—or one as straightforward as that.`,
    `5.8
Just as you overhear people saying that “the doctor
...
cause of well-being in what directs the world—of its wellbeing, its fulfillment, of its very existence, even. Because the
...
surefootedness. Their fluent stillness.`,
    `5.10
Things are wrapped in such a veil of mystery that many
...
Interrogate yourself, to find out what inhabits your socalled mind and what kind of soul you have now. A child’s
...
abundance leaves their owner with “. . . no place to shit.”`,
    `5.13
I am made up of substance and what animates it, and
...
activities “directed,” from the directness of their course.`,
    `5.15
Nothing pertains to human beings except what defines us
...
those that don’t. And those with the logos still higher.`,
    `5.17
It is crazy to want what is impossible. And impossible
for the wicked not to do so.`,
    `5.18
Nothing happens to anyone that he can’t endure. The same
...
ignorance and vanity?`,
    `5.19
Things have no hold on the soul. They have no access to
...
sees fit.`,
    `5.20
In a sense, people are our proper occupation. Our job is
...
What stands in the way becomes the way.`,
    `5.21
Honor that which is greatest in the world—that on whose
...
employed about its business, and your life is governed by it.`,
    `5.22
If it does not harm the community, it does not harm its
members.
...
Fate. How small a role you play in it.`,
    `5.25
So other people hurt me? That’s their problem. Their
character and actions are not mine. What is done to me is
ordained by nature, what I do by my own.`,
    `5.26
The mind is the ruler of the soul. It should remain
...
judgments, calling it “good” or “bad.”`,
    `5.27
“To live with the gods.” And to do that is to show them
...
each deserves, and brings the better things into alignment.`,
    `5.31
How have you behaved to the gods, to your parents, to
...
you been kind to?`,
    `5.32
Why do other souls—unskilled, untrained—disturb the
...
—and nothing else is under your control.`,
    `5.34
You can lead an untroubled life provided you can grow,
...
Where's the danger for the community?`,
    `5.36
Not to be overwhelmed by what you imagine, but just do
...
There as well: “to do what needs doing.”`,
    `6.3
Look inward. Don’t let the true nature or value of anything
elude you.`,
    `6.4
Before long, all existing things will be transformed, to rise
like smoke (assuming all things become one), or be
dispersed in fragments.`,
    `6.5
The logos knows where it stands, and what it has to do,
and what it has to work with.`,
    `6.6
The best revenge is not to be like that.`,
    `6.7
To move from one unselfish action to another with God in
mind.
Only there, delight and stillness.`,
    `6.8
The mind is that which is roused and directed by itself. It
makes of itself what it chooses. It makes what it chooses of
its own experience.`,
    `6.9
Everything is brought about by nature, not by anything
beyond it, or within it, or apart from it.`,
    `6.10
(i) Mixture, interaction, dispersal; or (ii) unity, order,
design.
...
endurable.`,
    `6.13
Like seeing roasted meat and other dishes in front of you
...
too.`,
    `6.20
In the ring, our opponents can gouge us with their nails or
...
ignorance.`,
    `6.22
I do what is mine to do; the rest doesn’t disturb me. The
...
into the life force of the world, or dissolved alike into atoms.`,
    `6.25
Think how much is going on inside you every second—in
...
unity, the world—is happening at the same time?`,
    `6.26
If someone asked you how to write your name, would you
...
anger with anger.`,
    `6.27
How cruel—to forbid people to want what they think is
...
your temper.`,
    `6.28
Death. The end of sense-perception, of being controlled
by our emotions, of mental activity, of enslavement to our
bodies.`,
    `6.29
Disgraceful: for the soul to give up when the body is still
going strong.`,
    `6.30
To escape imperialization—that indelible stain. It
...
clear as his.`,
    `6.31
Awaken; return to yourself. Now, no longer asleep,
...
meaningless.`,
    `6.33
It’s normal to feel pain in your hands and feet, if you’re
...
And if it’s normal, how can it be bad?`,
    `6.34
Thieves, perverts, parricides, dictators: the kind of
pleasures they enjoy.`,
    `6.35
Have you noticed how professionals will meet the man
...
same substance, the same form. All of it.`,
    `6.38
Keep reminding yourself of the way things are connected,
...
other, and breathe together, and are one.`,
    `6.39
The things ordained for you—teach yourself to be at one
with those. And the people who share them with you—treat
them with love.
With real love.`,
    `6.40
Implements, tools, equipment. If they do what they were
...
treat other people as enemies.`,
    `6.42
All of us are working on the same project. Some
...
working in common?`,
    `6.44
If the gods have made decisions about me and the things
...
placed on your body. Accept those placed on your time.`,
    `6.50
Do your best to convince them. But act on your own, if
...
themselves.`,
    `6.53
Practice really hearing what people say. Do your best to
get inside their minds.`,
    `6.54
What injures the hive injures the bee.`,
    `6.55
If the crew talked back to the captain, or patients to their
doctor, then whose authority would they accept? How could
the passengers be kept safe or the patient healthy?`,
    `6.56
All those people who came into the world with me and
have already left it.`,
    `6.57
Honey tastes bitter to a man with jaundice. People with
...
Nothing can happen to you that is not required by Nature.`,
    `6.59
The people they want to ingratiate themselves with, and
...
Familiar, transient.`,
    `7.2
You cannot quench understanding unless you put out the
...
And life returns.`,
    `7.3
Pointless bustling of processions, opera arias, herds of
...
other means.`,
    `7.5
Is my intellect up to this? If so, then I’ll put it to work, like
...
same resources to draw on—the same logos.`,
    `7.9
Everything is interwoven, and the web is holy; none of its
...
who share the same birth, the same logos.`,
    `7.10
All substance is soon absorbed into nature, all that
animates it soon restored to the logos, all trace of them both
soon covered over by time.`,
    `7.11
To a being with logos, an unnatural action is one that
conflicts with the logos.`,
    `7.12
Straight, not straightened.`,
    `7.13
What is rational in different beings is related, like the
...
me. I can choose not to.`,
    `7.15
No matter what anyone says or does, my task is to be
...
my color undiminished.”`,
    `7.16
The mind doesn’t get in its own way. It doesn’t frighten
...
vital to nature.`,
    `7.19
Carried through existence as through rushing rapids. All
...
They haven’t diminished your ability to choose.`,
    `7.23
Nature takes substance and makes a horse. Like a
...
badly has gone, why go on living?)`,
    `7.25
Before long, nature, which controls it all, will alter
...
—that it would upset you to lose them.`,
    `7.28
Self-contraction: the mind’s requirements are satisfied by
...
Other people’s mistakes? Leave them to their makers.`,
    `7.30
To direct your thoughts to what is said. To focus the mind
on what happens and what makes it happen.`,
    `7.31
Wash yourself clean. With simplicity, with humility, with
...
relative.” “ Which is little enough. “`,
    `7.32
[On death:] If atoms, dispersed. If oneness, quenched or
changed.`,
    `7.33
...
for themselves, if they can.`,
    `7.34
[On Ambition:] How their minds work, the things they

long for and fear. Events like piles of sand, drift upon drift—
each one soon hidden by the next.`,
    `7.35
“ ‘If his mind is filled with nobility, with a grasp of all
...
“Kingship: to earn a bad reputation by good deeds.”`,
    `7.37
Disgraceful: that the mind should control the face, should
be able to shape and mold it as it pleases, but not shape and
mold itself.`,
    `7.38
“And why should we feel anger at the world? As if the
world would notice!”`,
    `7.39
“May you bring joy to us and those on high.”`,
    `7.40
“To harvest life like standing stalks of grain Grown and
cut down in turn.”`,
    `7.41
“If I and my two children cannot move the gods The gods
...
wrong, and his behavior a good man’s or a bad one’s.’ ”`,
    `7.45
“It’s like this, gentlemen of the jury: The spot where a
...
about being killed, or about anything but doing his duty.”`,
    `7.46
“But, my good friend, consider the possibility that
...
opposites.`,
    `7.49
Look at the past—empire succeeding empire—and from
...
a better resource in tight places, a better forgiver of faults.`,
    `7.53
Wherever something can be done as the logos shared by
...
be able to hold its own.`,
    `7.56
Think of yourself as dead. You have lived your life. Now
take what’s left and live it properly.`,
    `7.57
To love only what happens, what was destined. No
greater harmony.`,
    `7.58
In all that happens, keep before your eyes those who
...
business is with things that really matter.`,
    `7.59
Dig deep; the water—goodness—is down there. And as
long as you keep digging, it will keep bubbling up.`,
    `7.60
What the body needs is stability. To be impervious to
...
But it should come without effort.`,
    `7.61
Not a dancer but a wrestler: waiting, poised and dug in,
for sudden assaults.`,
    `7.62
Look at who they really are, the people whose approval
...
to pain.”`,
    `7.65
Take care that you don’t treat inhumanity as it treats
human beings.`,
    `7.66
...
didn’t put his mind in his body’s keeping.`,
    `7.67
Nature did not blend things so inextricably that you can’t
...
achieving humility, serving others, obeying God.`,
    `7.68
To live life in peace, immune to all compulsion. Let them
...
without frenzy, or sloth, or pretense.`,
    `7.70
The gods live forever and yet they don’t seem annoyed at
...
inescapable. Just try to escape your own.`,
    `7.72
Whenever the force that makes us rational and social
encounters something that is neither, then it can reasonably
regard it as inferior.`,
    `7.73
You’ve given aid and they’ve received it. And yet, like
...
Then don’t object to what is useful to you—being of use.`,
    `7.75
Nature willed the creation of the world. Either all that
...
A source of serenity in more situations than one.`,
    `8.1
Another encouragement to humility: you can’t claim to
...
The others? Nothing but anxiety and enslavement.`,
    `8.4
You can hold your breath until you turn blue, but they’ll
...
hypocrisy.`,
    `8.6
Nature’s job: to shift things elsewhere, to transform them,
...
Everything is familiar. Even the proportions are unchanged.`,
    `8.7
Nature of any kind thrives on forward progress. And
...
people—even for caring about them—for that, yes.`,
    `8.9
Don’t be overheard complaining about life at court. Not
even to yourself.`,
    `8.10
Remorse is annoyance at yourself for having passed up
...
So it cannot be to your benefit, or good.`,
    `8.11
What is this, fundamentally? What is its nature and
...
Which are transformed in turn—without grumbling.`,
    `8.19
Everything is here for a purpose, from horses to vine
...
up to questioning.`,
    `8.20
Nature is like someone throwing a ball in the air, gauging
...
gods, and that source from which all things together flow.`,
    `8.24
Like the baths—oil, sweat, dirt, grayish water, all of it
disgusting.
...
iii. with the people around you.`,
    `8.28
Either pain affects the body (which is the body’s
...
evil can touch them.`,
    `8.29
To erase false perceptions, tell yourself: I have it in me
...
overlook this innate ability.`,
    `8.30
To speak to the Senate—or anyone—in the right tone,
without being overbearing. To choose the right words.`,
    `8.31
Augustus’s court: his wife, his daughter, his grandsons,
...
death of a whole house.`,
    `8.32
You have to assemble your life yourself—action by
...
what you’re trying to assemble. Action by action.`,
    `8.33
To accept it without arrogance, to let it go with
indifference.`,
    `8.34
Have you ever seen a severed hand or foot, or a
...
position once again: part of a whole.`,
    `8.35
We have various abilities, present in all rational
...
can’t hold out against that . . . well, then, heap shame upon it.`,
    `8.37
Are Pantheia or Pergamos still keeping watch at the tomb
...
Look at it clearly. If you can.`,
    `8.39
“To the best of my judgment, when I look at the human
character I see no virtue placed there to counter justice. But I
see one to counter pleasure: self-control.”`,
    `8.40
Stop perceiving the pain you imagine and you’ll remain
...
let it decide that for itself.`,
    `8.41
For animate beings, “harmful” is whatever obstructs the
...
sphere . . . in perfect stillness.”`,
    `8.42
I have no right to do myself an injury. Have I ever injured
anyone else if I could avoid it?`,
    `8.43
People find pleasure in different ways. I find it in
...
about you, or think y?`,
    `8.45
Lift me up and hurl me. Wherever you will. My spirit
...
embracing the obstacles too.`,
    `8.48
Remember that when it withdraws into itself and finds
...
misery.`,
    `8.49
Nothing but what you get from first impressions. That
...
all it needs: space, material, and labor.`,
    `8.51
No carelessness in your actions. No confusion in your
...
Through patience, honesty, humility.`,
    `8.52
Not to know what the world is is to be ignorant of where
you are.
...
diffused in those who accept it as air is in those who breathe.`,
    `8.55
The existence of evil does not harm the world. And an
...
soon as he decides to.`,
    `8.56
Other people’s wills are as independent of mine as their
...
What doesn’t transmit light creates its own darkness.`,
    `8.58
Fear of death is fear of what we may experience. Nothing
...
not cease.`,
    `8.59
People exist for one another. You can instruct or endure
them.`,
    `8.60
An arrow has one motion and the mind another. Even
...
and change, and their successive stages.`,
    `9.2
Real good luck would be to abandon life without ever
...
your humanity.`,
    `9.3
Don’t look down on death, but welcome it. It too is one of
...
“Come quickly. Before I start to forget myself, like them.”`,
    `9.4
To do harm is to do yourself harm. To do an injustice is to
...
Quench your appetites. Keep your mind centered on itself.`,
    `9.8
Animals without the logos are assigned the same soul, and
...
and breathe.`,
    `9.9
All things are drawn toward what is like them, if such a
...
humans can escape humanity.`,
    `9.10
Humanity, divinity, and the world: all of them bearing
...
outside.`,
    `9.14
Known by long experience, limited in life span, debased
...
The mind does.`,
    `9.16
Not being done to, but doing—the source of good and
...
down, gained nothing by going up.`,
    `9.18
Enter their minds, and you’ll find the judges you’re so
afraid of—and how judiciously they judge themselves.`,
    `9.19
Everything in flux. And you too will alter in the whirl and
...
and dreams and every other way—to get the things he wants.`,
    `9.28
The world’s cycles never change—up and down, from
age to age.
...
endlessly breaking. And see our brief mortality for what it is.`,
    `9.29
The design of the world is like a flood, sweeping all
...
Don’t tempt me to presumption.`,
    `9.30
To see them from above: the thousands of animal herds,
...
Redirect your prayers like that, and watch what happens.`,
    `9.41
Epicurus: “During my illness, my conversations were not
...
censure?`,
    `10.2
Focus on what nature demands, as if you were governed
...
In your interest, or in your nature.`,
    `10.4
If they’ve made a mistake, correct them gently and show
...
happen to you.`,
    `10.6
Whether it’s atoms or nature, the first thing to be said is
...
give and to receive?`,
    `10.10
Spiders are proud of catching flies, men of catching
hares, fish in a net, boars, bears, Sarmatians . . .
Criminal psychology.`,
    `10.11
How they all change into one another—acquire the
...
straight path—to God, by way of law.`,
    `10.12
Why all this guesswork? You can see what needs to be
...
chooses, loyalty, humility, truth, order, well-being.`,
    `10.14
Nature gives and nature takes away. Anyone with sense
and humility will tell her, “Give and take as you please,” not
out of defiance, but out of obedience and goodwill.`,
    `10.15
Only a short time left. Live as if you were alone—out in
...
(Better than living like this.)`,
    `10.16
To stop talking about what the good man is like, and just
be one.`,
    `10.17
Continual awareness of all time and space, of the size
and life span of the things around us. A grape seed in infinite
space. A half twist of a corkscrew against eternity.`,
    `10.18
Bear in mind that everything that exists is already fraying
at the edges, and in transition, subject to fragmentation and to
rot.

Or that everything was born to die.`,
    `10.19
How they act when they eat and sleep and mate and
...
—and the things they’ll submit to again before very long.`,
    `10.20
Each of us needs what nature gives us, when nature gives
it.`,
    `10.21
“The earth knows longing for the rain, the sky/knows
...
Those are the only options. Reason for optimism.`,
    `10.23
Keep always before you that “this is no different from an
...
urges?`,
    `10.25
When a slave runs away from his master, we call him a
...
to become a fugitive—a fugitive from justice.`,
    `10.26
He deposits his sperm and leaves. And then a force not
...
pulls them. Not with our eyes, but just as clearly.`,
    `10.27
To bear in mind constantly that all of this has happened
...
different.`,
    `10.28
People who feel hurt and resentment: picture them as the
...
do so voluntarily.`,
    `10.29
Stop whatever you’re doing for a moment and ask
yourself: Am I afraid of death because I won’t be able to do
this anymore?`,
    `10.30
When faced with people’s bad behavior, turn around and
...
throw on it, and makes it light and flame.`,
    `10.32
That no one can say truthfully that you are not a
...
contrary to the logos.`,
    `10.33
Given the material we’re made of, what’s the sanest thing
...
is safe, so is the city—and the citizen.`,
    `10.34
If you’ve immersed yourself in the principles of truth, the
...
stand pale colors, or teeth that can handle only mush.`,
    `10.36
It doesn’t matter how good a life you’ve led. There’ll
...
Starting with your own.`,
    `10.38
Remember that what pulls the strings is within—hidden
...
nature of people?)`,
    `11.6
First, tragedies. To remind us of what can happen, and that
...
all—the script and staging alike?`,
    `11.7
It stares you in the face. No role is so well suited to
...
alienated from his fellow humans.`,
    `11.10
The natural can never be inferior to the artificial; art
...
gullible, inconstant?`,
    `11.11
It’s the pursuit of these things, and your attempts to avoid
...
still, and you will be freed from fleeing and pursuing.`,
    `11.12
The soul as a sphere in equilibrium: Not grasping at
...
can harm you?`,
    `11.14
They flatter one another out of contempt, and their desire
...
None of us is forbidden to pursue our own good.`,
    `11.17
Source and substance of each thing. What it changes into,
and what it’s like transformed; that nothing can harm it.`,
    `11.18
i. My relationship to them. That we came into the world
...
is arrogant—the act of a tyrant.`,
    `11.19
Four habits of thought to watch for, and erase from your
...
degraded mortal part—the body and its stupid selfindulgence.`,
    `11.20
Your spirit and the fire contained within you are drawn
...
justice.`,
    `11.21
“If you don’t have a consistent goal in life, you can’t live
...
consistent. And so will you.`,
    `11.22
The town mouse and the country mouse. Distress and
agitation of the town mouse.`,
    `11.23
Socrates used to call popular beliefs “the monsters under
the bed”—only useful for frightening children with.`,
    `11.24
At festivals the Spartans put their guests’ seats in the
shade, but sat themselves down anywhere.`,
    `11.25
Socrates declining Perdiccas’s invitation “so as to avoid
dying a thousand deaths” (by accepting a favor he couldn’t
pay back).`,
    `11.26
This advice from Epicurean writings: to think continually
...
purity, nakedness. Stars wear no concealment.`,
    `11.28
Socrates dressed in a towel, the time Xanthippe took his
...
Socrates said to them.`,
    `11.29
Mastery of reading and writing requires a master. Still
more so life.`,
    `11.30
“. . . For you/Are but a slave and have no claim to
logos.”`,
    `11.31
...
“And jeer at virtue with their taunts and sneers.”`,
    `11.33
Stupidity is expecting figs in winter, or children in old
age.`,
    `11.34
As you kiss your son good night, says Epictetus, whisper
...
“No thefts of free will reported.”[—Epictetus.]`,
    `11.37
“We need to master the art of acquiescence. We need to
...
avoid what’s beyond our control.”`,
    `11.38
“This is not a debate about just anything,” he said, “but
about sanity itself.”`,
    `11.39
Socrates: What do you want, rational minds or irrational
ones?
—Rational ones.
Healthy or sick?
—Healthy.
...
Then why all this squabbling?`,
    `12.1
Everything you’re trying to reach—by taking the long way
...
No longer at the mercy of this, or that.`,
    `12.2
God sees all our souls freed from their fleshly containers,
...
mansions, celebrity—the painted sets, the costume cupboard?`,
    `12.3
Your three components: body, breath, mind. Two are
...
value other people’s opinions—instead of our own.`,
    `12.5
How is it that the gods arranged everything with such skill,
...
Fragility of matter.`,
    `12.8
To see the causes of things stripped bare. The aim of
actions.
...
purpose. No one is to blame.`,
    `12.13
The foolishness of people who are surprised by anything
...
Let your intention be < . . . >`,
    `12.18
At all times, look at the thing itself—the thing behind the
...
• and the length of time it exists.`,
    `12.19
It’s time you realized that you have something in you
...
ii. for any reason but the common good.`,
    `12.21
That before long you’ll be no one, and nowhere. Like all
...
perish. So that new things can be born.`,
    `12.22
It’s all in how you perceive it. You’re in control. You
can dispense with misperception at will, like rounding the
point. Serenity, total calm, safe anchorage.`,
    `12.23
A given action that stops when it’s supposed to is none
...
Arrogance . . . about this?`,
    `12.25
Throw out your misperceptions and you’ll be fine. (And
...
That the present is all we have to live in. Or to lose.`,
    `12.27
Constantly run down the list of those who felt intense
...
from having felt their power, over and over.`,
    `12.29
Salvation: to see each thing for what it is—its nature and
its purpose.
...
to grieve because death deprives us of them—is an obstacle.`,
    `12.32
The fraction of infinity, of that vast abyss of time, allotted
...
Nature sends you.`,
    `12.33
How the mind conducts itself. It all depends on that. All
the rest is within its power, or beyond its control—corpses
and smoke.`,
    `12.34
An incentive to treat death as unimportant: even people
