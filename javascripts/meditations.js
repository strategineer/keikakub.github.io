...
Never taken aback or apprehensive. Neither rash nor hesitant—or bewildered, or at a loss. Not obsequious
...
His searching questions at meetings. A kind of singlemindedness, almost, never content with first impressions, or breaking off the discussion prematurely.
...
And then there is necessity and the needs of the whole world, of which you are a part. Whatever the nature of the whole does, and whatever serves to maintain it, is good for every part of nature. The world is maintained by change—in the elements and in the things they compose. That should be enough for you; treat it as an axiom. Discard your thirst for books, so that you won’t die in bitterness, but in cheerfulness and truth, grateful to the gods from the bottom of your heart.`);
meditations.set("2.4",`2.4
...
meditations.set("2.12",`2.12
The speed with which all of them vanish—the objects in the world, and the memory of them in time. And the real nature of the things our senses experience, especially those that entice us with pleasure or frighten us with pain or are loudly trumpeted by pride. To understand those things—how stupid, contemptible, grimy, decaying, and dead they are—
that’s what our intellectual powers are for. And to understand what those people really amount to, whose opinions and voices constitute fame. And what dying is—and that if you look at it in the abstract and break down your imaginary ideas of it by logical analysis, you realize that it’s nothing but a process of nature, which only children can be afraid of. (And not only a process of nature but a necessary one.) And how man grasps God, with what part of himself he does so, and how that part is conditioned when he does.`);
meditations.set("2.13",`2.13
...
whatever we’re assigned—not worrying too often, or with any selfish motive, about what other people say. Or do, or think.
...
meditations.set("3.6",`3.6
If, at some point in your life, you should come across anything better than justice, honesty, self-control, courage—
than a mind satisfied that it has succeeded in enabling you to act rationally, and satisfied to accept what’s beyond its control—if you find anything better than that, embrace it without reservations—it must be an extraordinary thing indeed—and enjoy it to the full.
...
meditations.set("4.2",`4.2
No random actions, none not based on underlying principles.`);
meditations.set("4.3",`4.3
...
meditations.set("4.20",`4.20
Beautiful things of any kind are beautiful in themselves and sufficient to themselves. Praise is extraneous. The object of praise remains what it was—no better and no worse. This applies, I think, even to “beautiful” things in ordinary life—
...
Are any of those improved by being praised? Or damaged by contempt? Is an emerald suddenly flawed if no one admires it? Or gold, or ivory, or purple? Lyres? Knives? Flowers?
Bushes?`);
meditations.set("4.21",`4.21
...
meditations.set("4.34",`4.34
Hand yourself over to Clotho voluntarily, and let her spin you into whatever she pleases.`);
meditations.set("4.35",`4.35
Everything transitory—the knower and the known.`);
meditations.set("4.36",`4.36
Constant awareness that everything is born from change.
The knowledge that there is nothing nature loves more than to alter what exists and make new things like it. All that exists is the seed of what will emerge from it. You think the only seeds are the ones that make plants or children? Go deeper.`);
meditations.set("4.37",`4.37
...
meditations.set("4.45",`4.45
What follows coheres with what went before. Not like a random catalogue whose order is imposed upon it arbitrarily, but logically connected. And just as what exists is ordered and harmonious, what comes into being betrays an order too.
Not a mere sequence, but an astonishing concordance.`);
meditations.set("4.46",`4.46
...
“They are at odds with what is all around them”—the alldirecting logos. And “they find alien what they meet with every day.”
...
meditations.set("4.47",`4.47
Suppose that a god announced that you were going to die tomorrow “or the day after.” Unless you were a complete coward you wouldn’t kick up a fuss about which day it was
—what difference could it make? Now recognize that the difference between years from now and tomorrow is just as small.`);
meditations.set("4.48",`4.48
...
meditations.set("4.50",`4.50
A trite but effective tactic against the fear of death: think of the list of people who had to be pried away from life.
...
meditations.set("5.5",`5.5
No one could ever accuse you of being quick-witted.
All right, but there are plenty of other things you can’t claim you “haven’t got in you.” Practice the virtues you can show: honesty, gravity, endurance, austerity, resignation, abstinence, patience, sincerity, moderation, seriousness, high-mindedness. Don’t you see how much you have to offer
—beyond excuses like “can’t”? And yet you still settle for less.
...
—Yes. Except conscious of it. Because it’s characteristic of social beings that they see themselves as acting socially.
...
meditations.set("5.8",`5.8
Just as you overhear people saying that “the doctor prescribed such-and-such for him” (like riding, or cold baths, or walking barefoot . . .), say this: “Nature prescribed illness for him.” Or blindness. Or the loss of a limb. Or whatever. There “prescribed” means something like
...
Then look at the way the people around you behave. Even the best of them are hard to put up with—not to mention putting up with yourself. In such deep darkness, such a sewer
...
meditations.set("5.11",`5.11
What am I doing with my soul?
Interrogate yourself, to find out what inhabits your socalled mind and what kind of soul you have now. A child’s soul, an adolescent’s, a woman’s? A tyrant’s soul? The soul of a predator—or its prey?`);
meditations.set("5.12",`5.12
Another way to grasp what ordinary people mean by
“goods”:
...
“character.” Is wisdom really so much weaker than ignorance and vanity?`);
meditations.set("5.19",`5.19
...
meditations.set("5.23",`5.23
Keep in mind how fast things pass by and are gone—
those that are now, and those to come. Existence flows past us like a river: the “what” is in constant flux, the “why” has a thousand variations. Nothing is stable, not even what’s right here. The infinity of past and future gapes before us—a chasm whose depths we cannot see.
...
meditations.set("5.24",`5.24
Remember:
Matter. How tiny your share of it.
Time. How brief and fleeting your allotment of it.
Fate. How small a role you play in it.`);
meditations.set("5.25",`5.25
...
meditations.set("5.28",`5.28
Don’t be irritated at people’s smell or bad breath.
What’s the point? With that mouth, with those armpits, they’re going to produce that odor.
...
meditations.set("5.29",`5.29
You can live here as you expect to live there.
And if they won’t let you, you can depart life now and forfeit nothing. If the smoke makes me cough, I can leave.
...
Consider all that you’ve gone through, all that you’ve survived. And that the story of your life is done, your assignment complete. How many good things have you seen?
How much pain and pleasure have you resisted? How many honors have you declined? How many unkind people have you been kind to?`);
meditations.set("5.32",`5.32
...
meditations.set("5.33",`5.33
Soon you’ll be ashes, or bones. A mere name, at most—
and even that is just a sound, an echo. The things we want in life are empty, stale, and trivial. Dogs snarling at each other.
Quarreling children—laughing and then bursting into tears a moment later. Trust, shame, justice, truth—“gone from the earth and only found in heaven.”
...
meditations.set("6.5",`6.5
The logos knows where it stands, and what it has to do, and what it has to work with.`);
meditations.set("6.6",`6.6
The best revenge is not to be like that.`);
meditations.set("6.7",`6.7
To move from one unselfish action to another with God in mind.
Only there, delight and stillness.`);
meditations.set("6.8",`6.8
...
meditations.set("6.9",`6.9
Everything is brought about by nature, not by anything beyond it, or within it, or apart from it.`);
meditations.set("6.10",`6.10
(i) Mixture, interaction, dispersal; or (ii) unity, order, design.
Suppose (i): Why would I want to live in disorder and confusion? Why would I care about anything except the eventual “dust to dust”? And why would I feel any anxiety?
Dispersal is certain, whatever I do.

Or suppose (ii): Reverence. Serenity. Faith in the power responsible.`);
meditations.set("6.11",`6.11
...
meditations.set("6.14",`6.14
Things ordinary people are impressed by fall into the categories of things that are held together by simple physics
(like stones or wood), or by natural growth (figs, vines, olives . . .). Those admired by more advanced minds are held together by a living soul (flocks of sheep, herds of cows).
...
meditations.set("6.17",`6.17
The elements move upward, downward, in all directions.
The motion of virtue is different—deeper. It moves at a steady pace on a road hard to discern, and always forward.`);
meditations.set("6.18",`6.18
...
meditations.set("6.19",`6.19
Not to assume it’s impossible because you find it hard.
But to recognize that if it’s humanly possible, you can do it too.`);
meditations.set("6.20",`6.20
...
meditations.set("6.21",`6.21
If anyone can refute me—show me I’m making a mistake or looking at things from the wrong perspective—I’ll gladly change. It’s the truth I’m after, and the truth never harmed anyone. What harms us is to persist in self-deceit and ignorance.`);
meditations.set("6.22",`6.22
...
Take Antoninus as your model, always. His energy in doing what was rational . . . his steadiness in any situation . .
. his sense of reverence . . . his calm expression . . . his gentleness . . . his modesty . . . his eagerness to grasp things.
And how he never let things go before he was sure he had examined them thoroughly, understood them perfectly . . . the way he put up with unfair criticism, without returning it . . .
how he couldn’t be hurried . . . how he wouldn’t listen to informers . . . how reliable he was as a judge of character, and of actions . . . not prone to backbiting, or cowardice, or jealousy, or empty rhetoric . . . content with the basics—in living quarters, bedding, clothes, food, servants . . . how hard he worked, how much he put up with . . . his ability to work straight through till dusk—because of his simple diet (he didn’t even need to relieve himself, except at set times) . . .
his constancy and reliability as a friend . . . his tolerance of people who openly questioned his views and his delight at seeing his ideas improved on . . . his piety—without a trace of superstition . . .

So that when your time comes, your conscience will be as clear as his.`);
meditations.set("6.31",`6.31
...
Which are within its own control. And it’s only the immediate ones that matter. Its past and future actions too are meaningless.`);
meditations.set("6.33",`6.33
...
36a. Everything derives from it—that universal mind—either as effect or consequence. The lion’s jaws, the poisonous substances, and every harmful thing—from thorns to mud . . .
are by-products of the good and beautiful. So don’t look at them as alien to what you revere, but focus on the source that all things spring from.`);
meditations.set("6.37",`6.37
...
meditations.set("6.41",`6.41
You take things you don’t control and define them as
...
meditations.set("6.45",`6.45
Whatever happens to you is for the good of the world.
That would be enough right there. But if you look closely you’ll generally notice something else as well: whatever happens to a single person is for the good of others. (Good in the ordinary sense—as the world defines it.)`);
meditations.set("6.46",`6.46
Just as the arena and the other spectacles weary you—
you’ve seen them all before—and the repetition grates on your nerves, so too with life. The same things, the same causes, on all sides.
How much longer?`);
meditations.set("6.47",`6.47
...
meditations.set("6.51",`6.51
Ambition means tying your well-being to what other people say or do.
Self-indulgence means tying it to the things that happen to you.
Sanity means tying it to your own actions.`);
meditations.set("6.52",`6.52
You don’t have to turn this into something. It doesn’t have to upset you. Things can’t shape our decisions by themselves.`);
meditations.set("6.53",`6.53
Practice really hearing what people say. Do your best to get inside their minds.`);
meditations.set("6.54",`6.54
What injures the hive injures the bee.`);
meditations.set("6.55",`6.55
...
then how can I be troubled? What is outside my mind means nothing to it. Absorb that lesson and your feet stand firm.
You can return to life. Look at things as you did before.
And life returns.`);
meditations.set("7.3",`7.3
...
meditations.set("7.14",`7.14
Let it happen, if it wants, to whatever it can happen to.
And what’s affected can complain about it if it wants. It doesn’t hurt me unless I interpret its happening as harmful to me. I can choose not to.`);
meditations.set("7.15",`7.15
No matter what anyone says or does, my task is to be good. Like gold or emerald or purple repeating to itself, “No matter what anyone says or does, my task is to be emerald, my color undiminished.”`);
meditations.set("7.16",`7.16
...
meditations.set("7.20",`7.20
My only fear is doing something contrary to human nature
—the wrong thing, the wrong way, or at the wrong time.`);
meditations.set("7.21",`7.21
Close to forgetting it all, close to being forgotten.`);
meditations.set("7.22",`7.22
To feel affection for people even when they make mistakes is uniquely human. You can do it, if you simply recognize: that they’re human too, that they act out of ignorance, against their will, and that you’ll both be dead before long. And, above all, that they haven’t really hurt you.
They haven’t diminished your ability to choose.`);
meditations.set("7.23",`7.23
...
meditations.set("7.25",`7.25
Before long, nature, which controls it all, will alter everything you see and use it as material for something else
—over and over again. So that the world is continually renewed.`);
meditations.set("7.26",`7.26
When people injure you, ask yourself what good or harm they thought would come of it. If you understand that, you’ll feel sympathy rather than outrage or anger. Your sense of good and evil may be the same as theirs, or near it, in which case you have to excuse them. Or your sense of good and evil may differ from theirs. In which case they’re misguided and deserve your compassion. Is that so hard?`);
meditations.set("7.27",`7.27
...
meditations.set("7.34",`7.34
[On Ambition:] How their minds work, the things they long for and fear. Events like piles of sand, drift upon drift—
each one soon hidden by the next.`);
meditations.set("7.35",`7.35
“ ‘If his mind is filled with nobility, with a grasp of all time, all existence, do you think our human life will mean much to him at all?’
“ ‘How could it?’ he said.
“ ‘Or death be very frightening?’
“ ‘Not in the least.’ ”`);
meditations.set("7.36",`7.36
“Kingship: to earn a bad reputation by good deeds.”`);
meditations.set("7.37",`7.37
...
meditations.set("7.54",`7.54
Everywhere, at each moment, you have the option:

• to accept this event with humility
• to treat this person as he should be treated
• to approach this thought with care, so that nothing irrational creeps in.`);
meditations.set("7.55",`7.55
...
meditations.set("7.56",`7.56
Think of yourself as dead. You have lived your life. Now take what’s left and live it properly.`);
meditations.set("7.57",`7.57
To love only what happens, what was destined. No greater harmony.`);
meditations.set("7.58",`7.58
...
meditations.set("7.59",`7.59
Dig deep; the water—goodness—is down there. And as long as you keep digging, it will keep bubbling up.`);
meditations.set("7.60",`7.60
What the body needs is stability. To be impervious to jolts in all it is and does. The cohesiveness and beauty that intelligence lends to the face—that’s what the body needs.
But it should come without effort.`);
meditations.set("7.61",`7.61
Not a dancer but a wrestler: waiting, poised and dug in, for sudden assaults.`);
meditations.set("7.62",`7.62
...
as drowsiness, fever, loss of appetite. . . . When you’re bothered by things like that, remind yourself: “I’m giving in to pain.”`);
meditations.set("7.65",`7.65
Take care that you don’t treat inhumanity as it treats human beings.`);
meditations.set("7.66",`7.66
...
While Adaptability adds, “You’re just what I was looking for.” Because to me the present is a chance for the exercise of rational virtue—civic virtue—in short, the art that men share with gods. Both treat whatever happens as wholly natural; not novel or hard to deal with, but familiar and easily handled.`);
meditations.set("7.69",`7.69
Perfection of character: to live your last day, every day, without frenzy, or sloth, or pretense.`);
meditations.set("7.70",`7.70
...
meditations.set("7.71",`7.71
It’s silly to try to escape other people’s faults. They are inescapable. Just try to escape your own.`);
meditations.set("7.72",`7.72
...
meditations.set("8.6",`8.6
Nature’s job: to shift things elsewhere, to transform them, to pick them up and move them here and there. Constant alteration. But not to worry: there’s nothing new here.
Everything is familiar. Even the proportions are unchanged.`);
meditations.set("8.7",`8.7
...
meditations.set("8.8",`8.8
No time for reading. For controlling your arrogance, yes.

For overcoming pain and pleasure, yes. For outgrowing ambition, yes. For not feeling anger at stupid and unpleasant people—even for caring about them—for that, yes.`);
meditations.set("8.9",`8.9
Don’t be overheard complaining about life at court. Not even to yourself.`);
meditations.set("8.10",`8.10
...
meditations.set("8.13",`8.13
Apply them constantly, to everything that happens:

Physics. Ethics. Logic.`);
meditations.set("8.14",`8.14
...
Blame no one. Set people straight, if you can. If not, just repair the damage. And suppose you can’t do that either.
Then where does blaming people get you?
No pointless actions.`);
meditations.set("8.18",`8.18
...
meditations.set("8.30",`8.30
To speak to the Senate—or anyone—in the right tone, without being overbearing. To choose the right words.`);
meditations.set("8.31",`8.31
Augustus’s court: his wife, his daughter, his grandsons, his stepsons, his sister, Agrippa, the relatives, servants, friends, Areius, Maecenas, the doctors, the sacrificial priests
...
meditations.set("8.33",`8.33
To accept it without arrogance, to let it go with indifference.`);
meditations.set("8.34",`8.34
Have you ever seen a severed hand or foot, or a decapitated head, just lying somewhere far away from the body it belonged to . . . ? That’s what we do to ourselves—
or try to—when we rebel against what happens to us, when we segregate ourselves. Or when we do something selfish.
...
meditations.set("8.37",`8.37
Are Pantheia or Pergamos still keeping watch at the tomb of Verus? Chabrias or Diotimus at the tomb of Hadrian? Of course they aren’t. Would the emperors know it if they were?
...
meditations.set("8.56",`8.56
Other people’s wills are as independent of mine as their breath and bodies. We may exist for the sake of one another, but our will rules its own domain. Otherwise the harm they do would cause harm to me. Which is not what God intended
—for my happiness to rest with someone else.`);
meditations.set("8.57",`8.57
...
meditations.set("8.61",`8.61
To enter others’ minds and let them enter yours.`);
meditations.set("9.1",`9.1
...
means the nature of that which is. And that which is and that which is the case are closely linked, so that nature is synonymous with Truth—the source of all true things. To lie deliberately is to blaspheme—the liar commits deceit, and thus injustice. And likewise to lie without realizing it.
Because the involuntary liar disrupts the harmony of nature—
its order. He is in conflict with the way the world is structured. As anyone is who deviates toward what is opposed to the truth—even against his will. Nature gave him the resources to distinguish between true and false. And he neglected them, and now can’t tell the difference.
And to pursue pleasure as good, and flee from pain as evil
—that too is blasphemous. Someone who does that is bound to find himself constantly reproaching nature—complaining that it doesn’t treat the good and bad as they deserve, but often lets the bad enjoy pleasure and the things that produce it, and makes the good suffer pain, and the things that produce pain. And moreover, to fear pain is to fear something that’s bound to happen, the world being what it is—and that again is blasphemy. While if you pursue pleasure, you can hardly avoid wrongdoing—which is manifestly blasphemous.
...
meditations.set("9.2",`9.2
Real good luck would be to abandon life without ever encountering dishonesty, or hypocrisy, or self-indulgence, or pride. But the “next best voyage” is to die when you’ve had enough. Or are you determined to lie down with evil? Hasn’t experience even taught you that—to avoid it like the plague?
Because it is a plague—a mental cancer—worse than anything caused by tainted air or an unhealthy climate.
Diseases like that can only threaten your life; this one attacks your humanity.`);
meditations.set("9.3",`9.3
...
Even in irrational beings we see swarms and herds, and nesting, and love not unlike ours. Because they do have souls, and the bonding instinct is found in a developed form
...
But look how things are now. The rational things are the only ones that have lost that sense of attraction—of convergence. Only there do we not see that intermingling. But however much they try to avoid it, there’s no escaping.
...
meditations.set("9.13",`9.13
Today I escaped from anxiety. Or no, I discarded it, because it was within me, in my own perceptions—not outside.`);
meditations.set("9.14",`9.14
Known by long experience, limited in life span, debased in substance—all of it.
Now as then, in the time of those we buried.`);
meditations.set("9.15",`9.15
...
The mind does.`);
meditations.set("9.16",`9.16
Not being done to, but doing—the source of good and bad for rational and political beings. Where their own goodness and badness is found—not in being done to, but in doing.`);
meditations.set("9.17",`9.17
A rock thrown in the air. It loses nothing by coming down, gained nothing by going up.`);
meditations.set("9.18",`9.18
Enter their minds, and you’ll find the judges you’re so afraid of—and how judiciously they judge themselves.`);
meditations.set("9.19",`9.19
Everything in flux. And you too will alter in the whirl and perish, and the world as well.`);
meditations.set("9.20",`9.20
Leave other people’s mistakes where they lie.`);
meditations.set("9.21",`9.21
When we cease from activity, or follow a thought to its conclusion, it’s a kind of death. And it doesn’t harm us.
...
Your neighbor’s—to distinguish ignorance calculation. And recognize it as like yours.

from`);
meditations.set("9.23",`9.23
...
meditations.set("9.26",`9.26
Endless suffering—all from not allowing the mind to do its job. Enough.`);
meditations.set("9.27",`9.27
When you face someone’s insults, hatred, whatever . . .
look at his soul. Get inside him. Look at what sort of person he is. You’ll find you don’t need to strain to impress him.
...
Whether they knew nature’s will and made themselves its student is for them to say. And if they preferred to play the king? Well, no one forced me to be their understudy.
The task of philosophy is modest and straightforward.
Don’t tempt me to presumption.`);
meditations.set("9.30",`9.30
...
meditations.set("9.32",`9.32
You can discard most of the junk that clutters your mind
—things that exist only there—and clear out space for yourself:

. . . by comprehending the scale of the world
. . . by contemplating infinite time
. . . by thinking of the speed with which things change—
each part of every thing; the narrow space between our birth and death; the infinite time before; the equally unbounded time that follows.`);
meditations.set("9.33",`9.33
...
—than to be passively controlled by what isn’t, like a slave or beggar? And what makes you think the gods don’t care about what’s up to us?
...
And how does it injure you anyway? You’ll find that none of the people you’re upset about has done anything that could do damage to your mind. But that’s all that “harm” or
“injury” could mean. Yes, boorish people do boorish things.
What’s strange or unheard-of about that? Isn’t it yourself you should reproach—for not anticipating that they’d act this way? The logos gave you the means to see it—that a given person would act a given way—but you paid no attention.
And now you’re astonished that he’s gone and done it. So when you call someone “untrustworthy” or “ungrateful,” turn the reproach on yourself. It was you who did wrong. By assuming that someone with those traits deserved your trust.
...
meditations.set("10.5",`10.5
Whatever happens to you has been waiting to happen since the beginning of time. The twining strands of fate wove both of them together: your own existence and the things that happen to you.`);
meditations.set("10.6",`10.6
...
each individual thing—for what they are. And not losing the thread.
...
Seriousness? Or understanding individual things—their nature and substance, their place in the world, their life span, their composition, who can possess them, whose they are to give and to receive?`);
meditations.set("10.10",`10.10
Spiders are proud of catching flies, men of catching hares, fish in a net, boars, bears, Sarmatians . . .
Criminal psychology.`);
meditations.set("10.11",`10.11
How they all change into one another—acquire the ability to see that. Apply it constantly; use it to train yourself.
...
If anything gets in the way, forge on ahead, making good use of what you have on hand, sticking to what seems right. (The best goal to achieve, and the one we fall short of when we fail.)
12a. To follow the logos in all things is to be relaxed and energetic, joyful and serious at once.`);
meditations.set("10.13",`10.13
...
Let people see someone living naturally, and understand what that means. Let them kill him if they can’t stand it.
(Better than living like this.)`);
meditations.set("10.16",`10.16
To stop talking about what the good man is like, and just be one.`);
meditations.set("10.17",`10.17
...
meditations.set("10.19",`10.19
How they act when they eat and sleep and mate and defecate and all the rest. Then when they order and exult, or rage and thunder from on high. And yet, just consider the things they submitted to a moment ago, and the reasons for it
—and the things they’ll submit to again before very long.`);
meditations.set("10.20",`10.20
Each of us needs what nature gives us, when nature gives it.`);
meditations.set("10.21",`10.21
...
meditations.set("10.29",`10.29
Stop whatever you’re doing for a moment and ask yourself: Am I afraid of death because I won’t be able to do this anymore?`);
meditations.set("10.30",`10.30
...
meditations.set("10.31",`10.31
When you look at Satyron, see Socraticus, or Eutyches, or Hymen.
...
Nothing. Especially when you recall that once things alter they cease to exist through all the endless years to come.
Then why such turmoil? To live your brief life rightly, isn’t that enough?
The raw material you’re missing, the opportunities . . . !
What is any of this but training—training for your logos, in life observed accurately, scientifically.
...
Simply resolve not to go on living if you aren’t. It would be contrary to the logos.`);
meditations.set("10.33",`10.33
...
“Everyone must approve of me” is like eyes that can only stand pale colors, or teeth that can handle only mush.`);
meditations.set("10.36",`10.36
...
Even with the intelligent and good. Won’t there be someone thinking “Finally! To be through with that old schoolteacher. Even though he never said anything, you could always feel him judging you.” And that’s for a good man.
...
meditations.set("11.9",`11.9
As you move forward in the logos, people will stand in your way. They can’t keep you from doing what’s healthy;
don’t let them stop you from putting up with them either. Take care on both counts. Not just sound judgments, solid actions
—tolerance as well, for those who try to obstruct us or give us trouble in other ways.
...
meditations.set("11.10",`11.10
The natural can never be inferior to the artificial; art imitates nature, not the reverse. In which case, that most highly developed and comprehensive nature—Nature itself—
...
Like Phocion (if he wasn’t just pretending). That’s what we should be like inside, and never let the gods catch us feeling anger or resentment.
...
Keeping in mind that none of them can dictate how we perceive it. They don’t impose themselves on us. They hover before us, unmoving. It is we who generate the judgments—
inscribing them on ourselves. And we don’t have to. We could leave the page blank—and if a mark slips through, erase it instantly.
...
that human life is very short. Before long all of us will be laid out side by side.
...
and a man. That’s who possesses strength and nerves and guts, not the angry whiners. To react like that brings you closer to impassivity—and so to strength. Pain is the opposite of strength, and so is anger. Both are things we suffer from, and yield to.
...
And the fourth reason for self-reproach: that the more divine part of you has been beaten and subdued by the degraded mortal part—the body and its stupid selfindulgence.`);
meditations.set("11.20",`11.20
...
So why should your intellect be the only dissenter—the only one complaining about its posting? It’s not as if anything is being forced on it. Only what its own nature requires. And yet it refuses to comply, and sets off in the opposite direction. Because to be drawn toward what is wrong and self-indulgent, toward anger and fear and pain, is to revolt against nature. And for the mind to complain about anything that happens is to desert its post. It was created to show reverence—respect for the divine—no less than to act justly.
That too is an element of coexistence and a prerequisite for justice.`);
meditations.set("11.21",`11.21
...
meditations.set("11.29",`11.29
Mastery of reading and writing requires a master. Still more so life.`);
meditations.set("11.30",`11.30
“. . . For you/Are but a slave and have no claim to logos.”`);
meditations.set("11.31",`11.31
“But my heart rejoiced.”`);
meditations.set("11.32",`11.32
“And jeer at virtue with their taunts and sneers.”`);
meditations.set("11.33",`11.33
Stupidity is expecting figs in winter, or children in old age.`);
meditations.set("11.34",`11.34
...
Don’t let anything deter you: other people’s misbehavior, your own misperceptions, What People Will Say, or the feelings of the body that covers you (let the affected part take care of those). And if, when it’s time to depart, you shunt everything aside except your mind and the divinity within . . .
...
—and prohibited us from concealing our thoughts or imagining anything without immediately shouting it out, we wouldn’t make it through a single day. That’s how much we value other people’s opinions—instead of our own.`);
meditations.set("12.5",`12.5
How is it that the gods arranged everything with such skill, such care for our well-being, and somehow overlooked one thing: that certain people—in fact, the best of them, the gods’
own partners, the ones whose piety and good works brought them closest to the divine—that these people, when they die, should cease to exist forever? Utterly vanished.
...
meditations.set("12.7",`12.7
The condition of soul and body when death comes for us.
Shortness of life.
Vastness of time before and after.
Fragility of matter.`);
meditations.set("12.8",`12.8
To see the causes of things stripped bare. The aim of actions.
...
meditations.set("12.17",`12.17
If it’s not right, don’t do it. If it’s not true, don’t say it.
Let your intention be < . . . >`);
meditations.set("12.18",`12.18
...
meditations.set("12.23",`12.23
A given action that stops when it’s supposed to is none the worse for stopping. Nor the person engaged in it either.
So too with the succession of actions we call “life.” If it ends when it’s supposed to, it’s none the worse for that. And the person who comes to the end of the line has no cause for complaint. The time and stopping point are set by nature—
our own nature, in some cases (death from old age); or nature as a whole, whose parts, shifting and changing, constantly renew the world, and keep it on schedule.
...
But if you can do without them all, then continue to follow the logos, and God. To the end. To prize those other things—
to grieve because death deprives us of them—is an obstacle.`);
meditations.set("12.32",`12.32
